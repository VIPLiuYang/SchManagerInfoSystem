...
namespace SchSystem.DAL
{
	...
	public partial class SysMater
	{
        ...
        public bool ExistsCode(string code)
        {
            ...
            strSql.Append(" where MaterCode=@MaterCode ");
            SqlParameter[] parameters = {
					new SqlParameter("@MaterCode", SqlDbType.VarChar,10)	};
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("AutoId", "SysMater"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from SysMater");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SchSystem.Model.SysMater model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SysMater(");
			strSql.Append("MaterName,MaterCode,Stat)");
			strSql.Append(" values (");
			strSql.Append("@MaterName,@MaterCode,@Stat)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@MaterName", SqlDbType.NVarChar,20),
					new SqlParameter("@MaterCode", SqlDbType.VarChar,10),
					new SqlParameter("@Stat", SqlDbType.TinyInt,1)};
			parameters[0].Value = model.MaterName;
			parameters[1].Value = model.MaterCode;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SchSystem.Model.SysMater model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SysMater set ");
			strSql.Append("MaterName=@MaterName,");
		...
		public bool Delete(int AutoId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SysMater ");
			strSql.Append(" where AutoId=@AutoId");
			SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SchSystem.Model.SysMater GetModel(int AutoId)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 AutoId,MaterName,MaterCode,Stat from SysMater ");
			strSql.Append(" where AutoId=@AutoId");
			SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
			...
			SchSystem.Model.SysMater model=new SchSystem.Model.SysMater();
		...
		/// 得到一个对象实体
		/// </summary>
		public SchSystem.Model.SysMater DataRowToModel(DataRow row)
		{
			SchSystem.Model.SysMater model=new SchSystem.Model.SysMater();
			if (row != null)
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" AutoId,MaterName,MaterCode,Stat ");
			strSql.Append(" FROM SysMater ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SysMater T ");
