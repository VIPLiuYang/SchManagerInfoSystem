...
{
	/// <summary>
	/// 数据访问类:SchMenuInfoUserFuncSoure
	/// </summary>
	public partial class SchMenuInfoUserFuncSoure
	{
		public SchMenuInfoUserFuncSoure()
		{}
		#region  BasicMethod
        public DataSet GetList(string Cols, string strWhere)
        {
            ...
            strSql.Append(" FROM SchMenuInfoUserFuncSoure ");
            if (strWhere.Trim() != "")
            {
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("MenuId", "SchMenuInfoUserFuncSoure"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from SchMenuInfoUserFuncSoure");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SchSystem.Model.SchMenuInfoUserFuncSoure model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SchMenuInfoUserFuncSoure(");
			strSql.Append("Pid,Expn,NavUrl,SelAct,Targets,TextName,FuncCode,FuncLv,AppCode,OrderId,Stat,Ico)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@AppCode", SqlDbType.TinyInt,1),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SchSystem.Model.SchMenuInfoUserFuncSoure model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SchMenuInfoUserFuncSoure set ");
		...
		public bool Delete(int MenuId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SchMenuInfoUserFuncSoure ");
			strSql.Append(" where MenuId=@MenuId");
			SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SchSystem.Model.SchMenuInfoUserFuncSoure GetModel(int MenuId)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 MenuId,Pid,Expn,NavUrl,SelAct,Targets,TextName,FuncCode,FuncLv,AppCode,OrderId,Stat,Ico from SchMenuInfoUserFuncSoure ");
			strSql.Append(" where MenuId=@MenuId");
			SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
			...
			SchSystem.Model.SchMenuInfoUserFuncSoure model=new SchSystem.Model.SchMenuInfoUserFuncSoure();
		...
		/// 得到一个对象实体
		/// </summary>
		public SchSystem.Model.SchMenuInfoUserFuncSoure DataRowToModel(DataRow row)
		{
			SchSystem.Model.SchMenuInfoUserFuncSoure model=new SchSystem.Model.SchMenuInfoUserFuncSoure();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select MenuId,Pid,Expn,NavUrl,SelAct,Targets,TextName,FuncCode,FuncLv,AppCode,OrderId,Stat,Ico ");
			strSql.Append(" FROM SchMenuInfoUserFuncSoure ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" MenuId,Pid,Expn,NavUrl,SelAct,Targets,TextName,FuncCode,FuncLv,AppCode,OrderId,Stat,Ico ");
			strSql.Append(" FROM SchMenuInfoUserFuncSoure ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SchMenuInfoUserFuncSoure T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SchMenuInfoUserFuncSoure";
