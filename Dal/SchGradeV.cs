...
namespace SchSystem.DAL
{
    ...
    public partial class SchGradeV
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select PerName,PerCode,SysGradeName,GradeCode,GradeId,GradeYear,GradeName,SchId,IsFinish,CollCode,MajorCode ");
            strSql.Append(" FROM SchGradeV ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" PerName,PerCode,SysGradeName,GradeCode,GradeId,GradeYear,GradeName,SchId,IsFinish,CollCode,MajorCode ");
            strSql.Append(" FROM SchGradeV ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM SchGradeV ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from SchGradeV T ");
