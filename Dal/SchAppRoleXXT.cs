...
namespace SchSystem.DAL
{
	...
	public partial class SchAppRoleXXT
	{
        ...
        public DataSet GetList(string cols, string strWhere)
        {
            ...
            strSql.Append(" FROM SchAppRoleXXT ");
            if (strWhere.Trim() != "")
            {
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("AutoId", "SchAppRoleXXT"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from SchAppRoleXXT");
		...
		public bool Delete(int AutoId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SchAppRoleXXT ");
			strSql.Append(" where AutoId=@AutoId");
			SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SchAppRoleXXT T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SchAppRoleXXT";
