...
{
	/// <summary>
	/// 数据访问类:SchMenuInfoIntegral
	/// </summary>
	public partial class SchMenuInfoIntegral
	{
		public SchMenuInfoIntegral()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("MenuId", "SchMenuInfoIntegral"); 
		}
		...
		public bool Exists(int MenuId)
		{
			...
			strSql.Append("select count(1) from SchMenuInfoIntegral");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SchSystem.Model.SchMenuInfoIntegral model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SchMenuInfoIntegral(");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@FuncLv", SqlDbType.VarChar,20),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SchSystem.Model.SchMenuInfoIntegral model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SchMenuInfoIntegral set ");
		...
		public bool Delete(int MenuId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SchMenuInfoIntegral ");
			strSql.Append(" where MenuId=@MenuId");
			SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SchSystem.Model.SchMenuInfoIntegral GetModel(int MenuId)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 MenuId,Pid,Expn,NavUrl,SelAct,Targets,TextName,FuncCode,FuncLv,AppCode,OrderId,Stat,Ico from SchMenuInfoIntegral ");
			strSql.Append(" where MenuId=@MenuId");
			SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
			...
			SchSystem.Model.SchMenuInfoIntegral model=new SchSystem.Model.SchMenuInfoIntegral();
		...
		/// 得到一个对象实体
		/// </summary>
		public SchSystem.Model.SchMenuInfoIntegral DataRowToModel(DataRow row)
		{
			SchSystem.Model.SchMenuInfoIntegral model=new SchSystem.Model.SchMenuInfoIntegral();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM SchMenuInfoIntegral ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SchMenuInfoIntegral T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SchMenuInfoIntegral";
