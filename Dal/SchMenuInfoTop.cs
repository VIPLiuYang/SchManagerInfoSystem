...
namespace SchSystem.DAL
{
    ...
    public partial class SchMenuInfoTop
    {
        ...
        public bool Exists(int MenuId)
        {
            ...
            strSql.Append("select count(1) from SchMenuInfoTop");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into SchMenuInfoTop(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SchMenuInfoTop set ");
        ...
        public bool Delete(int MenuId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from SchMenuInfoTop ");
            strSql.Append(" where MenuId=@MenuId");
            SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
        ...
        public SchSystem.Model.SchMenuInfoTop GetModel(int MenuId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 MenuId,Pid,Expn,NavUrl,SelAct,Targets,TextName,FuncCode,FuncLv,AppCode,OrderId,Stat,Ico from SchMenuInfoTop ");
            strSql.Append(" where MenuId=@MenuId");
            SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
            ...
            SchSystem.Model.SchMenuInfoTop model = new SchSystem.Model.SchMenuInfoTop();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SchMenuInfoTop DataRowToModel(DataRow row)
        {
            SchSystem.Model.SchMenuInfoTop model = new SchSystem.Model.SchMenuInfoTop();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM SchMenuInfoTop ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from SchMenuInfoTop T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "SchMenuInfoTop";
