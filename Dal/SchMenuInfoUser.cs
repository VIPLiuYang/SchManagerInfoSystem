...
namespace SchSystem.DAL
{
    ...
    public partial class SchMenuInfoUser
    {
        ...
        public DataSet GetList(string Cols, string strWhere)
        {
            ...
            strSql.Append(" FROM SchMenuInfoUser ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from SchMenuInfoUser");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into SchMenuInfoUser(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SchMenuInfoUser set ");
        ...
        public bool Delete(int MenuId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from SchMenuInfoUser ");
            strSql.Append(" where MenuId=@MenuId");
            SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
        ...
        public SchSystem.Model.SchMenuInfoUser GetModel(int MenuId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 MenuId,Pid,Expn,NavUrl,SelAct,Targets,TextName,FuncCode,FuncLv,OrderId,Stat,Ico from SchMenuInfoUser ");
            strSql.Append(" where MenuId=@MenuId");
            SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
            ...
            SchSystem.Model.SchMenuInfoUser model = new SchSystem.Model.SchMenuInfoUser();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SchMenuInfoUser DataRowToModel(DataRow row)
        {
            SchSystem.Model.SchMenuInfoUser model = new SchSystem.Model.SchMenuInfoUser();
            if (row != null)
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from SchMenuInfoUser T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "SchMenuInfoUser";
