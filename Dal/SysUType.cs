...
namespace SchSystem.DAL
{
	...
	public partial class SysUType
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("AutoId", "SysUType"); 
		}
		...
		public bool Exists(int AutoId)
		{
			...
			strSql.Append("select count(1) from SysUType");
		...
		public bool Delete(int AutoId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SysUType ");
			strSql.Append(" where AutoId=@AutoId");
			SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select AutoId,UTypeName,UTypeCode,Stat ");
			strSql.Append(" FROM SysUType ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" AutoId,UTypeName,UTypeCode,Stat ");
			strSql.Append(" FROM SysUType ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SysUType T ");
