...
{
	/// <summary>
	/// 数据访问类:ServUserForDetail
	/// </summary>
	public partial class ServUserForDetail
	{
		public ServUserForDetail()
		{}
		#region  BasicMethod
        public DataSet GetList(string cols, string strWhere)
        {
            ...
            strSql.Append(" FROM ServUserForDetail ");
            if (strWhere.Trim() != "")
            {
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("AutoId", "ServUserForDetail"); 
		}
        /// <summary>
        /// 数据分页
        /// </summary>
        ...
        public DataSet GetListCols(string cols, string strWhere, string ordercols, string orderby, int PageIndex, int PageSize, ref int RowCount, ref int PageCount)
        {
            ...
            strSql.Append(" FROM ServUserForDetailV  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from ServUserForDetail");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SchSystem.Model.ServUserForDetail model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ServUserForDetail(");
			strSql.Append("UserName,FromType,RecUser,ServiceId,ServMonth,FeeM,RecTime,EndTime,EditTime,DoNote)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SchSystem.Model.ServUserForDetail model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update ServUserForDetail set ");
		...
		public bool Delete(int AutoId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ServUserForDetail ");
			strSql.Append(" where AutoId=@AutoId");
			SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SchSystem.Model.ServUserForDetail GetModel(int AutoId)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 AutoId,UserName,FromType,RecUser,ServiceId,ServMonth,FeeM,RecTime,EndTime,EditTime,DoNote from ServUserForDetail ");
			strSql.Append(" where AutoId=@AutoId");
			SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
			...
			SchSystem.Model.ServUserForDetail model=new SchSystem.Model.ServUserForDetail();
		...
		/// 得到一个对象实体
		/// </summary>
		public SchSystem.Model.ServUserForDetail DataRowToModel(DataRow row)
		{
			SchSystem.Model.ServUserForDetail model=new SchSystem.Model.ServUserForDetail();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select AutoId,UserName,FromType,RecUser,ServiceId,ServMonth,FeeM,RecTime,EndTime,EditTime,DoNote ");
			strSql.Append(" FROM ServUserForDetail ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" AutoId,UserName,FromType,RecUser,ServiceId,ServMonth,FeeM,RecTime,EndTime,EditTime,DoNote ");
			strSql.Append(" FROM ServUserForDetail ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ServUserForDetail T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "ServUserForDetail";
