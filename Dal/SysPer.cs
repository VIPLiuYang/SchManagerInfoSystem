...
namespace SchSystem.DAL
{
	...
	public partial class SysPer
	{
        ...
        public bool ExistsCode(string code)
        {
            ...
            strSql.Append(" where GradeType=@GradeType ");
            SqlParameter[] parameters = {
					new SqlParameter("@GradeType", SqlDbType.VarChar,10)	};
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("AutoId", "SysPer"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from SysPer");
		...
		public bool Delete(int AutoId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SysPer ");
			strSql.Append(" where AutoId=@AutoId");
			SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select AutoId,PerName,PerCode,Stat ");
			strSql.Append(" FROM SysPer ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" AutoId,PerName,PerCode,Stat ");
			strSql.Append(" FROM SysPer ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SysPer T ");
