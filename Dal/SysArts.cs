...
namespace SchSystem.DAL
{
    ...
    public partial class SysArts
    {
        ...
        public bool Exists(int AutoId)
        {
            ...
            strSql.Append("select count(1) from SysArts");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into SysArts(");
            strSql.Append("ArtsName,ArtsCode,Stat)");
            strSql.Append(" values (");
            strSql.Append("@ArtsName,@ArtsCode,@Stat)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
					new SqlParameter("@ArtsName", SqlDbType.NVarChar,20),
					new SqlParameter("@ArtsCode", SqlDbType.VarChar,10),
					new SqlParameter("@Stat", SqlDbType.TinyInt,1)};
            parameters[0].Value = model.ArtsName;
            parameters[1].Value = model.ArtsCode;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SysArts set ");
            strSql.Append("ArtsName=@ArtsName,"); 
        ...
        public bool Delete(int AutoId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from SysArts ");
            strSql.Append(" where AutoId=@AutoId");
            SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
        ...
        public SchSystem.Model.SysArts GetModel(int AutoId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 AutoId,ArtsName,ArtsCode,Stat from SysArts ");
            strSql.Append(" where AutoId=@AutoId");
            SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
            ...
            SchSystem.Model.SysArts model = new SchSystem.Model.SysArts();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SysArts DataRowToModel(DataRow row)
        {
            SchSystem.Model.SysArts model = new SchSystem.Model.SysArts();
            if (row != null)
            {
                ...
                if (row["ArtsName"] != null)
                {
                    model.ArtsName = row["ArtsName"].ToString();
                }
                if (row["ArtsCode"] != null)
                {
                    model.ArtsCode = row["ArtsCode"].ToString();
                }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select AutoId,ArtsName,ArtsCode,Stat ");
            strSql.Append(" FROM SysArts ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" AutoId,ArtsName,ArtsCode,Stat ");
            strSql.Append(" FROM SysArts ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from SysArts T ");
