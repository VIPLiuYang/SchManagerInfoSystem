...
namespace SchSystem.DAL
{
	...
	public partial class SysFasc
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("AutoId", "SysFasc"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from SysFasc");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SchSystem.Model.SysFasc model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SysFasc(");
			strSql.Append("FascName,FascCode,Stat)");
			strSql.Append(" values (");
			strSql.Append("@FascName,@FascCode,@Stat)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@FascName", SqlDbType.NVarChar,10),
					new SqlParameter("@FascCode", SqlDbType.VarChar,10),
					new SqlParameter("@Stat", SqlDbType.TinyInt,1)};
			parameters[0].Value = model.FascName;
			parameters[1].Value = model.FascCode;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SchSystem.Model.SysFasc model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SysFasc set ");
			strSql.Append("FascName=@FascName,");
		...
		public bool Delete(int AutoId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SysFasc ");
			strSql.Append(" where AutoId=@AutoId");
			SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SchSystem.Model.SysFasc GetModel(int AutoId)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 AutoId,FascName,FascCode,Stat from SysFasc ");
			strSql.Append(" where AutoId=@AutoId");
			SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
			...
			SchSystem.Model.SysFasc model=new SchSystem.Model.SysFasc();
		...
		/// 得到一个对象实体
		/// </summary>
		public SchSystem.Model.SysFasc DataRowToModel(DataRow row)
		{
			SchSystem.Model.SysFasc model=new SchSystem.Model.SysFasc();
			if (row != null)
			{
				...
				if(row["FascName"]!=null)
				{
					model.FascName=row["FascName"].ToString();
				}
				if(row["FascCode"]!=null)
				{
					model.FascCode=row["FascCode"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select AutoId,FascName,FascCode,Stat ");
			strSql.Append(" FROM SysFasc ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" AutoId,FascName,FascCode,Stat ");
			strSql.Append(" FROM SysFasc ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SysFasc T ");
