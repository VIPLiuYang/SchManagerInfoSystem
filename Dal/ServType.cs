...
namespace SchSystem.DAL
{
    ...
    public partial class ServType
    {
        ...
        public bool Exists(int AutoId)
        {
            ...
            strSql.Append("select count(1) from ServType");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into ServType(");
            strSql.Append("TypeName,TypeCode)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update ServType set ");
        ...
        public bool Delete(int AutoId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from ServType ");
            strSql.Append(" where AutoId=@AutoId");
            SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
        ...
        public SchSystem.Model.ServType GetModel(int AutoId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 AutoId,TypeName,TypeCode from ServType ");
            strSql.Append(" where AutoId=@AutoId");
            SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
            ...
            SchSystem.Model.ServType model = new SchSystem.Model.ServType();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.ServType DataRowToModel(DataRow row)
        {
            SchSystem.Model.ServType model = new SchSystem.Model.ServType();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select AutoId,TypeName,TypeCode ");
            strSql.Append(" FROM ServType ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" AutoId,TypeName,TypeCode ");
            strSql.Append(" FROM ServType ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from ServType T ");
