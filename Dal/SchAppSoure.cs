...
namespace SchSystem.DAL
{
	...
	public partial class SchAppSoure
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("AutoId", "SchAppSoure"); 
		}
		...
		public bool Exists(int AutoId)
		{
			...
			strSql.Append("select count(1) from SchAppSoure");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SchAppSoure(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SchAppSoure set ");
		...
		public bool Delete(int AutoId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SchAppSoure ");
			strSql.Append(" where AutoId=@AutoId");
			SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
        ...
        public SchSystem.Model.SchAppSoure GetModel(int AutoId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 AutoId,AppCode,AppName,Stat,RecTime,RecUser,LastRecTime,LastRecUser from SchAppSoure ");
			strSql.Append(" where AutoId=@AutoId");
			SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
            ...
            SchSystem.Model.SchAppSoure model = new SchSystem.Model.SchAppSoure();
		...
		/// 得到一个对象实体
		/// </summary>
        public SchSystem.Model.SchAppSoure DataRowToModel(DataRow row)
		{
            SchSystem.Model.SchAppSoure model = new SchSystem.Model.SchAppSoure();
			if (row != null)
			{
		...
		public DataSet GetList(string cols,string strWhere)
		{
            ...
            strSql.Append(cols);
			strSql.Append(" FROM SchAppSoure ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SchAppSoure T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SchAppSoure";
