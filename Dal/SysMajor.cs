...
namespace SchSystem.DAL
{
    ...
    public partial class SysMajor
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from SysMajor");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(SchSystem.Model.SysMajor model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into SysMajor(");
            strSql.Append("MajorName,MajorCode,Stat)");
            strSql.Append(" values (");
            strSql.Append("@MajorName,@MajorCode,@Stat)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
					new SqlParameter("@MajorName", SqlDbType.NVarChar,20),
            ...
            parameters[1].Value = model.MajorCode;
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SchSystem.Model.SysMajor model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SysMajor set ");
        ...
        public bool Delete(int AutoId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from SysMajor ");
            strSql.Append(" where AutoId=@AutoId");
            SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SysMajor GetModel(int AutoId)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 AutoId,MajorName,MajorCode,Stat from SysMajor ");
            strSql.Append(" where AutoId=@AutoId");
            SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SysMajor DataRowToModel(DataRow row)
        {
            SchSystem.Model.SysMajor model = new SchSystem.Model.SysMajor();
            if (row != null)
            {
                ...
                if (row["MajorCode"] != null)
                {
                    model.MajorCode = row["MajorCode"].ToString();
                }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select AutoId,MajorName,MajorCode,Stat ");
            strSql.Append(" FROM SysMajor ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" AutoId,MajorName,MajorCode,Stat ");
            strSql.Append(" FROM SysMajor ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from SysMajor T ");
