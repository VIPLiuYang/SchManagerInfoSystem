...
{
	/// <summary>
	/// 数据访问类:SchUserRoleSoure
	/// </summary>
	public partial class SchUserRoleSoure
	{
		public SchUserRoleSoure()
		{}
		#region  BasicMethod
        ...
        public int DoUserRole(string UserName, string RecUser, string SchId, string RoleIds)
        {
            ...
            strSql.Append("delete from SchUserRoleSoure where UserName='" + UserName + "' and SchId=" + SchId);
            strSql.Append(" insert into SchUserRoleSoure(RoleID,UserName,RecTime,RecUser,LastRecTime,LastRecUser,SchId)");
            strSql.Append(" select RoleID,'" + UserName + "',getdate(),'" + RecUser + "',getdate(),'" + RecUser + "','" + SchId + "' from SchRoleSoure where RoleID in (" + RoleIds + ")");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from SchUserRoleSoure");
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("AutoId", "SchUserRoleSoure"); 
		}
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SchSystem.Model.SchUserRoleSoure model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SchUserRoleSoure(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SchSystem.Model.SchUserRoleSoure model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SchUserRoleSoure set ");
		...
		public bool Delete(int AutoId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SchUserRoleSoure ");
			strSql.Append(" where AutoId=@AutoId");
			SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SchSystem.Model.SchUserRoleSoure GetModel(int AutoId)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 AutoId,RoleID,UserName,RecTime,RecUser,LastRecTime,LastRecUser,SchId from SchUserRoleSoure ");
			strSql.Append(" where AutoId=@AutoId");
			SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
			...
			SchSystem.Model.SchUserRoleSoure model=new SchSystem.Model.SchUserRoleSoure();
		...
		/// 得到一个对象实体
		/// </summary>
		public SchSystem.Model.SchUserRoleSoure DataRowToModel(DataRow row)
		{
			SchSystem.Model.SchUserRoleSoure model=new SchSystem.Model.SchUserRoleSoure();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM SchUserRoleSoure ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SchUserRoleSoure T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SchUserRoleSoure";
