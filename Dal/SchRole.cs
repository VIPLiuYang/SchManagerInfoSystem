...
namespace SchSystem.DAL
{
    ...
    public partial class SchRole
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(SchSystem.Model.SchRole model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into SchRole(");
            ...
            parameters[2].Value = model.RoleExtStr;
        ...
        /// 更新一条数据
        /// </summary>
        public bool UpdateStat(SchSystem.Model.SchRole model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SchRole set ");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SchSystem.Model.SchRole model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SchRole set ");
        ...
        public bool Delete(int RoleId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from SchRole ");
            strSql.Append(" where RoleId=@RoleId");
            SqlParameter[] parameters = {
					new SqlParameter("@RoleId", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SchRole GetModel(int RoleId)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 RoleId,RoleName,RoleStr,Stat,RecTime,RecUser,LastRecTime,LastRecUser,SchId,SysType from SchRole ");
            strSql.Append(" where RoleId=@RoleId");
            SqlParameter[] parameters = {
					new SqlParameter("@RoleId", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SchRole DataRowToModel(DataRow row)
        {
            SchSystem.Model.SchRole model = new SchSystem.Model.SchRole();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select RoleId,RoleName,RoleStr,Stat,RecTime,RecUser,LastRecTime,LastRecUser,SchId,SysType ");
            strSql.Append(" FROM SchRole ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" RoleId,RoleName,RoleStr,Stat,RecTime,RecUser,LastRecTime,LastRecUser,SchId,SysType ");
            strSql.Append(" FROM SchRole ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM SchRole ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from SchRole T ");
