...
namespace SchSystem.DAL
{
    ...
    public partial class SysTerm
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from SysTerm");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(SchSystem.Model.SysTerm model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into SysTerm(");
            strSql.Append("TermName,TermCode)");
            strSql.Append(" values (");
            strSql.Append("@TermName,@TermCode)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
					new SqlParameter("@TermName", SqlDbType.NVarChar,10),
					new SqlParameter("@TermCode", SqlDbType.VarChar,10)};
            parameters[0].Value = model.TermName;
            parameters[1].Value = model.TermCode;
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SchSystem.Model.SysTerm model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SysTerm set ");
        ...
        public bool Delete(int AutoId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from SysTerm ");
            strSql.Append(" where AutoId=@AutoId");
            SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SysTerm GetModel(int AutoId)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 AutoId,TermName,TermCode from SysTerm ");
            strSql.Append(" where AutoId=@AutoId");
            SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
            ...
            SchSystem.Model.SysTerm model = new SchSystem.Model.SysTerm();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SysTerm DataRowToModel(DataRow row)
        {
            SchSystem.Model.SysTerm model = new SchSystem.Model.SysTerm();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select AutoId,TermName,TermCode ");
            strSql.Append(" FROM SysTerm ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" AutoId,TermName,TermCode ");
            strSql.Append(" FROM SysTerm ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from SysTerm T ");
