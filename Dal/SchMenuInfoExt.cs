...
namespace SchSystem.DAL
{
	...
	public partial class SchMenuInfoExt
	{
		...
		public int GetMaxId()
		{
		    return DbHelperSQL.GetMaxID("MenuId", "SchMenuInfoExt"); 
		}
		...
		public bool Exists(int MenuId)
		{
			...
			strSql.Append("select count(1) from SchMenuInfoExt");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SchMenuInfoExt(");
			strSql.Append("Pid,Expn,NavUrl,SelAct,Targets,TextName,FuncCode,FuncLv,OrderId,Ico,Stat)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@Ico", SqlDbType.VarChar,300),
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SchMenuInfoExt set ");
		...
		public bool Delete(int MenuId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SchMenuInfoExt ");
			strSql.Append(" where MenuId=@MenuId");
			SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
		...
		public SchSystem.Model.SchMenuInfoExt GetModel(int MenuId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 MenuId,Pid,Expn,NavUrl,SelAct,Targets,TextName,FuncCode,FuncLv,OrderId,Ico,Stat from SchMenuInfoExt ");
			strSql.Append(" where MenuId=@MenuId");
			SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
			...
			SchSystem.Model.SchMenuInfoExt model=new SchSystem.Model.SchMenuInfoExt();
		...
		/// 得到一个对象实体
		/// </summary>
		public SchSystem.Model.SchMenuInfoExt DataRowToModel(DataRow row)
		{
			SchSystem.Model.SchMenuInfoExt model=new SchSystem.Model.SchMenuInfoExt();
			if (row != null)
			{
		...
		/// <summary>
        /// 获得数据列表:MenuId,Pid,Expn,NavUrl,SelAct,Targets,TextName,FuncCode,FuncLv,OrderId,Ico,Stat
		/// </summary>
		public DataSet GetList(string cols,string strWhere)
		{
			...
			strSql.Append(" FROM SchMenuInfoExt ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" MenuId,Pid,Expn,NavUrl,SelAct,Targets,TextName,FuncCode,FuncLv,OrderId,Ico,Stat ");
			strSql.Append(" FROM SchMenuInfoExt ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SchMenuInfoExt T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SchMenuInfoExt";
