...
namespace SchSystem.DAL
{
	...
	public partial class SchRoleSoure
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("RoleId", "SchRoleSoure"); 
		}
        /// <summary>
        /// 更新一条数据
        /// </summary>
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from SchRoleSoure");
			strSql.Append(" where RoleId=@RoleId");
			SqlParameter[] parameters = {
					new SqlParameter("@RoleId", SqlDbType.Int,4)
			};
		...
		public bool Delete(int RoleId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SchRoleSoure ");
			strSql.Append(" where RoleId=@RoleId");
			SqlParameter[] parameters = {
					new SqlParameter("@RoleId", SqlDbType.Int,4)
			};
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM SchRoleSoure ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SchRoleSoure T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SchRoleSoure";
