...
namespace SchSystem.DAL
{
    ...
    public partial class SchMenuInfoUserFuncXXT
    {
        ...
        public DataSet GetList(string Cols, string strWhere)
        {
            ...
            strSql.Append(" FROM SchMenuInfoUserFuncXXT ");
            if (strWhere.Trim() != "")
            {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("MenuId", "SchMenuInfoUserFuncXXT");
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from SchMenuInfoUserFuncXXT");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(SchSystem.Model.SchMenuInfoUserFuncXXT model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into SchMenuInfoUserFuncXXT(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SchSystem.Model.SchMenuInfoUserFuncXXT model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SchMenuInfoUserFuncXXT set ");
        ...
        public bool Delete(int MenuId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from SchMenuInfoUserFuncXXT ");
            strSql.Append(" where MenuId=@MenuId");
            SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SchMenuInfoUserFuncXXT GetModel(int MenuId)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 MenuId,Pid,Expn,NavUrl,SelAct,Targets,TextName,FuncCode,FuncLv,AppCode,OrderId,Stat,Ico from SchMenuInfoUserFuncXXT ");
            strSql.Append(" where MenuId=@MenuId");
            SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
            ...
            SchSystem.Model.SchMenuInfoUserFuncXXT model = new SchSystem.Model.SchMenuInfoUserFuncXXT();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SchMenuInfoUserFuncXXT DataRowToModel(DataRow row)
        {
            SchSystem.Model.SchMenuInfoUserFuncXXT model = new SchSystem.Model.SchMenuInfoUserFuncXXT();
            if (row != null)
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from SchMenuInfoUserFuncXXT T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "SchMenuInfoUserFuncXXT";
