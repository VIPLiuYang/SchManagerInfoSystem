...
namespace SchSystem.DAL
{
    ...
    /// 数据访问类:SchAppXXT
    /// </summary>
    public partial class SchAppXXT
    {
        public SchAppXXT()
        { }
        #region  BasicMethod
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("AutoId", "SchAppXXT");
        }
        ...
        public bool Exists(int AutoId)
        {
            ...
            strSql.Append("select count(1) from SchAppXXT");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(SchSystem.Model.SchAppXXT model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into SchAppXXT(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(SchSystem.Model.SchAppXXT model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SchAppXXT set ");
        ...
        public bool Delete(int AutoId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from SchAppXXT ");
            strSql.Append(" where AutoId=@AutoId");
            SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SchAppXXT GetModel(int AutoId)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 AutoId,AppCode,AppName,Stat,RecTime,RecUser,LastRecTime,LastRecUser from SchAppXXT ");
            strSql.Append(" where AutoId=@AutoId");
            SqlParameter[] parameters = {
					new SqlParameter("@AutoId", SqlDbType.Int,4)
			};
            ...
            SchSystem.Model.SchAppXXT model = new SchSystem.Model.SchAppXXT();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SchAppXXT DataRowToModel(DataRow row)
        {
            SchSystem.Model.SchAppXXT model = new SchSystem.Model.SchAppXXT();
            if (row != null)
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from SchAppXXT T ");
