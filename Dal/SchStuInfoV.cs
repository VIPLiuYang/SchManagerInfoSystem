...
namespace SchSystem.DAL
{
    ...
    public partial class SchStuInfoV
    {
        ...
        public DataSet GetList(string cols, string strWhere)
        {
            ...
            strSql.Append(cols);
            strSql.Append(" FROM SchStuInfoV ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select SchId,SchName,AreaNo,IsCity,Stat,GradeCode,GradeName,GradeId,IsFinish,ClassId,ClassName,ClssIsfinish,StuId,StuName,CardNo,StuStat,Sex,StuNo ");
            strSql.Append(" FROM SchStuInfoV ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" SchId,SchName,AreaNo,IsCity,Stat,GradeCode,GradeName,GradeId,IsFinish,ClassId,ClassName,ClssIsfinish,StuId,StuName,CardNo,StuStat,Sex,StuNo ");
            strSql.Append(" FROM SchStuInfoV ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM SchStuInfoV ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from SchStuInfoV T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "SchStuInfoV";
