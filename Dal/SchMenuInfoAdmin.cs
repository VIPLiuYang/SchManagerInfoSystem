...
namespace SchSystem.DAL
{
    ...
    public partial class SchMenuInfoAdmin
    {
        ...
        public DataSet GetList(string Cols, string strWhere)
        {
            ...
            strSql.Append(" FROM SchMenuInfoAdmin ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from SchMenuInfoAdmin");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into SchMenuInfoAdmin(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SchMenuInfoAdmin set ");
        ...
        public bool Delete(int MenuId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from SchMenuInfoAdmin ");
            strSql.Append(" where MenuId=@MenuId");
            SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
        ...
        public SchSystem.Model.SchMenuInfoAdmin GetModel(int MenuId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 MenuId,Pid,Expn,NavUrl,SelAct,Targets,TextName,FuncCode,FuncLv,OrderId,Stat,Ico from SchMenuInfoAdmin ");
            strSql.Append(" where MenuId=@MenuId");
            SqlParameter[] parameters = {
					new SqlParameter("@MenuId", SqlDbType.Int,4)
			};
            ...
            SchSystem.Model.SchMenuInfoAdmin model = new SchSystem.Model.SchMenuInfoAdmin();
        ...
        /// 得到一个对象实体
        /// </summary>
        public SchSystem.Model.SchMenuInfoAdmin DataRowToModel(DataRow row)
        {
            SchSystem.Model.SchMenuInfoAdmin model = new SchSystem.Model.SchMenuInfoAdmin();
            if (row != null)
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from SchMenuInfoAdmin T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "SchMenuInfoAdmin";
