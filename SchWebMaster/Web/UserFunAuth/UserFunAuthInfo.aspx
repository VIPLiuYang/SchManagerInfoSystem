<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserFunAuthInfo.aspx.cs" Inherits="SchWebMaster.Web.UserFunAuth.UserFunAuthInfo" %>
                ...
                $.each(eval("(" + data + ")").list, function (index, item) { //遍历返回的json
                    ...
                    if (isedit == "True") {
                        if (item.UserName == "" && item.UserName.length <= 0) {
                            ...
                            str += '    <a class="blue" href="javascript:updateuser(' + item.UserId + ')" onclick="go();">';
                    ...
                    if (isedit == "True") {
                        if (item.UserName == "" && item.UserName.length <= 0) {
                            ...
                            str += '            <li>';
                            str += '                <a href="javascript:updateuser(' + item.UserId + ')" onclick="go();" class="tooltip-info" data-rel="tooltip" title="修改">';
                            str += '                    <span class="blue">';
                            str += '                        <i class="icon-pencil bigger-130"></i>';
                            str += '                    </span>';
                            str += '                </a>';
