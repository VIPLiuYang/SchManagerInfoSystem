        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Com.Session.systype == "1")
                {
                    ...
                    sbarea.Append(Com.Public.GetDrpArea("4", Com.Session.schid, ref gradeid, false));
                    ...
                    sbarea.Append(Com.Public.GetDrpArea("5", gradeid, ref classid, false));
                    sbarea.Append("</select>&nbsp;&nbsp;&nbsp;&nbsp;");
                    //获取班主任及任课老师
        ...
        public static string getarea(string typecode, string pcode)
        {
            ...
            else
            {
                try
                {
                    string selp = "";
                    if (typecode != "6")
                        ret = Com.Public.GetDrpAreaStu(Com.Public.SqlEncStr(typecode), Com.Public.SqlEncStr(pcode), ref selp, false);
