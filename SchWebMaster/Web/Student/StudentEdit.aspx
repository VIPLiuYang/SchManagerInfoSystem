<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentEdit.aspx.cs" Inherits="SchWebMaster.Web.Student.StudentEdit" %>
...
<body>
                                ...
                                <form class="form-horizontal" role="form">
                                    ...
                                    <div class=" form-inline  lheight">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="Addr" placeholder="请输入地址" maxlength="50" data-toggle="tooltip" onblur="checkTxt(this,'^.{0,50}$')" title="50个汉字" class="col-xs-12 col-sm-12" />
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="col-sm-4 no-padding-right text-right">
    ...
    <script type="text/javascript">
        ...
        if (umodel != "1") {   
            ...
            $("#oldclassid").val(umodel[0].ClassId);
            $("#oldclassname").val(umodel[0].ClassName);
            $("#oldgradeid").val(umodel[0].GradeId);
            $("#oldgradename").val(umodel[0].GradeName);
            ...
            $("#oldClassName").html(umodel[0].OldClassId);
        }
        else { 
            //type = 'A';//添加A
            $("#title").text("添加");//更新标题
        ...
        $('#nj').change(function () { 
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "StudentEdit.aspx/getusers",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
