<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserFuncXXTInfo.aspx.cs" Inherits="SchWebMaster.Web.UserFuncXXT.UserFuncXXTInfo" %>
...
<body ontouchstart>
    ...
    <script type="text/javascript">
        ...
        function getdata() {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "UserFuncXXTInfo.aspx/page",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
        ...
        function DelRun(schid, userid) {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "UserFuncXXTInfo.aspx/udel",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
        ...
        function CreatUserModal(schid, systype, ostype) {
            if (ostype == "a") {
                ...
                var url = "UserXXT.aspx?dotype=a&schid=" + schid + "&systype=" + systype;
            } else if (ostype == "e") {
                $("#EditCfmCreateUser .modal-title").html("修改人员权限");
                var url = "UserXXT.aspx?dotype=e&uid=" + schid + "&systype=" + systype;
            }
