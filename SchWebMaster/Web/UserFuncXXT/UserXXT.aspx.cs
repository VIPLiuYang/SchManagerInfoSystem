...
namespace SchWebMaster.Web.UserFuncXXT
{
    public partial class UserXXT : System.Web.UI.Page
    {
        public string uid;
        public string uno;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (usermodel != null && usermodel.UserId > 0)
            {
                ...
                SchSystem.BLL.SchRoleXXT rolebll = new SchSystem.BLL.SchRoleXXT();
                ...
                //获取该用户关联的角色
                SchSystem.BLL.SchUserRoleXXTV urolevbll = new SchSystem.BLL.SchUserRoleXXTV();
                ...
                SchSystem.BLL.SchMenuInfoUserFuncXXT funcbll = new SchSystem.BLL.SchMenuInfoUserFuncXXT();
