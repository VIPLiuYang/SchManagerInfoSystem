<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchSubLeadEdit.aspx.cs" Inherits="SchWebMaster.Web.SubLeader.SchSubLeadEdit" %>
...
<body ontouchstart>
            ...
            <div class="main-content" style="margin-left: 0px">
                <div class="page-content">
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="row">
                            <div class="col-xs-12 no-padding-right">
                                <label style="line-height: 30px" class="ziti">科目组长:</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6" style="font-family: 微软雅黑 !important; color: #f96161;">点击选择组长：</div>
                        </div>
                        <div class="space-2"></div>
                        <div class="row">
                            <div class="col-xs-12 no-padding-right">
                                <div class="col-xs-6 no-padding-right" style="height: 300px; overflow: auto; border: 1px solid #999999; border-radius: 5px;">
                                    <ul id="Treedpt" class="ztree" style="display: block;"></ul>
                                </div>
                                <div class="col-xs-6" style="height: 300px; overflow: auto; border: 1px solid #999999; border-radius: 5px;">
    ...
    <script type="text/javascript">
        ...
        if(umodel!="1")
        {
            $("#schgradename").html(umodel.SubName);
    ...
    <script type="text/javascript">
        ...
        function saveuser()
        {
            var schgradename=$("#schgradename").html().trim();//科目名称
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SchSubLeadEdit.aspx/gradesave",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    {
                        alert("操作成功");
                        window.parent.closeEditCfmmodel("suber");
    ...
    <script type="text/javascript"> 
        ...
        $(document).ready(function(){
            treedpt = $.fn.zTree.init($("#Treedpt"), settingdpt, zNodesDpt);
            if(schuser)
            {
