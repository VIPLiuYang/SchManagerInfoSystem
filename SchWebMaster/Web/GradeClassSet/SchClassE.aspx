<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchClassE.aspx.cs" Inherits="SchWebMaster.Web.GradeClassSet.SchClassE" %>
...
<body ontouchstart>
            ...
            <div class="main-content" style="margin-left: 0px">
                <div class="page-content">
                    ...
                    <div class="form-horizontal">
                        <div class="row">
                            <div class="col-xs-2 text-right titleheight weiruan biaoti">年级:</div>
                            <div class="col-xs-8 no-padding-right">
                                <select id="gradelist" class="neirong" disabled="disabled" style="background-color: #EEEEEE;"><%=gradesdrp%></select><span id="gradeboss" style="margin-left: 10px;" class="tishi">年级领导：<%=gradeboss %></span>
                            </div>
                        </div>
                        <div class="space-4"></div>
                        <div class="row">

                            <div class="col-xs-2 text-right titleheight weiruan biaoti">班级名称:</div>
                            <div class="col-xs-5 no-padding-right weiruan">

                                <input type="text" id="txtname" placeholder="班级名称" title="必填" onblur="checkTxt(this,'^{1,25}$')" class="drpsub neirong" maxlength="25" disabled="disabled" />
                            </div>
                        ...
                        <div class="form-group form-inline">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-2 text-right titleheight weiruan biaoti">班主任:</div>

                                    <div class="col-xs-10">
                                        <div class="row">
                                            <div class="col-xs-5">
                                                <div class="btn-group btn-block">
                                                    <button data-toggle="dropdown" id="btntree_1" name="tecnames" value="" valuename="" class="btn btn-info btn-sm dropdown-toggle btn-block weiruan " onclick="dptuserdrp(this,'tree_1');">
                                                        选择老师
                                            ...
                                            <div class="col-xs-5">
                                                <select class="form-control col-sm-2 weiruan" name="tecsubs" id="drpsub_1">
                                                    <option value="" class="neirong">选择科目</option>
                                                    <%=subsdrp %>
                                                </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-2 text-right titleheight weiruan biaoti">科任老师:</div>

                                    <div class="col-xs-10" id="TeacherAddList">
                                        <%-- <div class="space-2"></div>--%>
                                        <div class="row" id="initdiv">
                                            <div class="col-xs-5">
                                                <select class="form-control col-sm-2 weiruan" name="tecsubs" id="drpsub_0" style="display: none;">
                                                    <option value="" class="neitong">选择科目</option>
                                                    <%=subsdrp %>
                                                </select>
                                            </div>
                                            <div class="col-xs-5">
                                                <div class="btn-group btn-block" style="display: none;">
                                                    <button data-toggle="dropdown" id="btntree_0" name="tecnames0" class="btn btn-info btn-sm dropdown-toggle btn-block weiruan " onclick="dptuserdrp(this,'tree_0');">
                                                        选择老师
													<span class="icon-caret-down icon-on-right spanziti"></span>
                                                    </button>
                                ...
                                <div class="row tr">
                                    <div class="col-xs-12 text-right">
                                        <button type="button" class="btn btn-info btn-sm" style="font-family: 微软雅黑" onclick="saveuser()"><%=btnname %></button>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <script type="text/javascript">
        ...
        {//alert(name);
            ...
            txtteclist +='<a href="#" class="tooltip-error deltecdiv" data-rel="tooltip" style="line-height:28px" title="删除" rel="' + i  +'">';
        ...
        function saveuser()
        {
            ...
            if(tecnames.length>0)
            {
                ...
                for (var i = 0; i < tecnames.length; i++) {
                    //if($(tecnames[i]).attr("value")==""||$(tecsubs[i]).val()==""){alert("请选择老师或科目！");return false;}
                    ...
                    if(i==0)
                    {
                        if($(tecnames[i]).attr("value")!=undefined&&$(tecsubs[i]).val()!=undefined&&$(tecnames[i]).attr("value")!=""&&$(tecsubs[i]).val()!="")
                        {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    {
                        alert("操作成功");
                        window.parent.closeEditCfmmodel("classer");
    ...
    <script>
        ...
        $('#gradelist').change(function () {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "../SubLeader/SubLeaderInfo.aspx/getSearch",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
