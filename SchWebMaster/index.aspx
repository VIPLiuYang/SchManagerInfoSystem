<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SchWebMaster.index" %>
...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" href="assets/css/ace.min.css?v=1" />
            ...
            <div class="sidebar" id="sidebar">
                ...
                <ul class="nav nav-list">
                    ...
                    <%--                    <li>
                        ...
                        <ul class="submenu">
                            <li class="atg">
                                <a href="faq.html" target="iframe0">
