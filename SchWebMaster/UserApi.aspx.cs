...
namespace SchWebMaster
{
    public partial class UserApi : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                rsp.RspData = Com.Public.Encrypt("schid:" + Com.Session.schid + "|uid:" + Com.Session.userid + "|upw:" + Com.Session.userpw + "|utp:" + Com.Session.usertp + "|utid:" + Com.Session.usertid + "|ulgt:" + Com.Session.ulogintime, Com.Public.getKey("ApiSecretKey"));
