  <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SchWebAdmin.index" %>
                ...
                <ul class="nav ace-nav">
                    ...
                    <li class="green Set_box ">
                        ...
                        <ul class="user-menu  dropdown-menu dropdown-yellow dropdown-caret dropdown-close ">
                            <li class="p-left">
                                <a href="./UploadFile.aspx?schid=<%=schid %>&userid=<%=usertid %>&schtype=2" target="iframe0" class="text_color">
    ...
    <div class="main-container" id="main-container">
        ...
        <div class="main-container-inner">
            ...
            <div class="main-content">
                <div class="page-content no-padding-right">
