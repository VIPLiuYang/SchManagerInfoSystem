<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userpwdapp.aspx.cs" Inherits="SchWebAdmin.userpwdapp" %>
                    ...
                    <div class="col-xs-12  col-sm-10 col-sm-offset-2">
                        ...
                        <form class="form-horizontal  " role="form">
                            ...
                            <div class="form-group form-inline ">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="username" placeholder="用户名" data-toggle="tooltip" class="col-xs-10 col-sm-5" maxlength="25" disabled="disabled" readonly="readonly" value="<%=username %>" />
                                </div>
                            </div>
                            <div class="form-group form-inline ">
                                <label class="col-sm-3 control-label no-padding-right">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" id="password" placeholder="密码" data-toggle="tooltip" title="字母和数字的长度6-18位组合" onblur="checkTxt(this,'^([a-zA-Z0-9]{6,18})$')" maxlength="18" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            <div class="form-group form-inline ">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" id="pwd" placeholder="确认密码" data-toggle="tooltip" title="字母和数字的长度6-18位组合" onblur="checkTxt(this,'^([a-zA-Z0-9]{6,18})$')" maxlength="18" class="col-xs-10 col-sm-5" />
                                </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.d == 'success') {
                        alert("修改成功!");
                        if (appurl != "") {
                            window.top.location.href = appurl + '?val=success';
                        }
                    }
                    else {
                        alert(data.d);
