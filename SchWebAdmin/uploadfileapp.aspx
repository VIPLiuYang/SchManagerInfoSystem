<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uploadfileapp.aspx.cs" Inherits="SchWebAdmin.uploadfileapp" %>
<!DOCTYPE html>
...
.tishi {
    ...
    <input id="btnfile" name="btnfile" accept="image/gif, image/jpeg, image/jpg, image/png" type="file" style="display:none;"/>
    <a class="file">浏览</a>
    <p id="userheadpic"></p>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //$(".file").on("change", "input[type='file']", function () {
                var size = 0;
                size = $('#btnfile')[0].files[0].size;//byte  
                size = size / 1024;//kb  
                size = size / 1024;//mb
                if (size > 2)
                {
