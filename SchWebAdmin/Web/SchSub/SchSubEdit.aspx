<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchSubEdit.aspx.cs" Inherits="SchWebAdmin.Web.SchSub.SchSubEdit" %>
...
<body ontouchstart>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3 no-padding-right">
                                    <div class="input-group">
                                        <input class="form-control date-picker" id="SonSysEndTime" style="cursor:pointer" type="text" data-date-format="yyyy-mm-dd" readonly="true" />
    ...
    <script type="text/javascript">
        ...
        if(umodel!="1")
        {
            ...
            $('#SonSysEndTime').val(umodel.SchSonSysEndDateTime.substring(0,10));
            if(umodel.IsSonArrears!=1){
                $("#SonSysStat").val(umodel.SonSysStat);
            }else{
                $("#SonSysStat").val("3");
            }
        }
        ...
        function saveuser()
        {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SchSubEdit.aspx/schsubsave",  //请求路径：页面/方法名字
