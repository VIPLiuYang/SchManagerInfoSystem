...
{
    public partial class SchContentList : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static Com.DataPack.DataRsp<string> page(string PageIndex, string PageSize, string txtserstat, string cotycode, string schname, string aprovserch, string acityserch, string txtschid)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(txtserstat))
                    {
                        strwhere += " and SonSysStat  = '" + Com.Public.SqlEncStr(txtserstat) + "'";
                    }
                    ...
                    int rowc = 0;
                    int pc = 0;
                    string dbcols = "SchId,SchName,PlatformName,PlatformUrl,PlatformIco,PlatformIP,SchMaster,SchoolSection,ServiceName,Artisan,SchCreator,RecTime,Stat,SonSysStat,AreaNo";//,iscity
