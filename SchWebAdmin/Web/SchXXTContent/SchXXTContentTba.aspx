<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchXXTContentTba.aspx.cs" Inherits="SchWebAdmin.Web.SchXXTContent.SchXXTContentTba" %> 
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
            ...
            <div class="main-content" style="margin-left: 0px">
                ...
                <div class="page-content">
                    ...
                    <ul class="nav nav-tabs" id="myTab">
                        <li id="mr"><a href="#jcxx" data-toggle="tab"   onclick="clickiframe('xxtz','xxtz.aspx')">学校通知</a></li>
                    ...
                    <div class="tab-content">
                        <!------------------------------------------------------------学校基本信息----------------------------------------------------------------------------------------------->
                        <!--默认选择home active-->
                        <div class="tab-pane active"  id="xxtz">
                        </div>
                        <!------------------------------------------------------------子系统及菜单----------------------------------------------------------------------------------------------->
...
<script type="text/javascript">
    ...
    function clickiframe(id, dz) {
        if (id == "xxtz") {
            var xxtzstr = "";
            xxtzstr = thdurl.replace("{0}", sessionid);
            xxtzstr = xxtzstr.replace("{1}", schid);
            document.getElementById(id).innerHTML = "<iframe class=\"content\" name=\"iframe1\" id=\"iframe1\" style=\"width: 100%;height:100%;\" frameborder=\"no\" border=\"0\" marginwidth=\"0\" marginheight=\"0\" src=\""+xxtzstr+"\"  frameborder=\"0\"></iframe>";
        }
    }
