...
{
    public partial class SchXXTContentTba : System.Web.UI.Page
    {

        public string schid = "0";//学校ID
        public string areastr = "";
        //public string xxtzstr = "";//学校通知
        public string thdurl = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                thdurl = Com.Public.getKey("Schnotice");
                //xxtzstr = string.Format(Com.Public.getKey("Schnotice"), Session.SessionID, schid);//学校通知
