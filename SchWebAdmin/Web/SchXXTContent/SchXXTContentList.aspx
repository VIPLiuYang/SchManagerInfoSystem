<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchXXTContentList.aspx.cs" Inherits="SchWebAdmin.Web.SchXXTContent.SchXXTContentList" %>
...
<body ontouchstart>
    ...
    <script type="text/javascript">
        ...
        function go() {
            sessionStorage.setItem("schxxtcontentlist", $("#main-container").html()); //存储列表数据
            //缓存查询条件
            sessionStorage.setItem("schxxtcontentlist_pageindex", PageIndex);
            sessionStorage.setItem("schxxtcontentlist_pagesize", PageSize);
            sessionStorage.setItem("schxxtcontentlist_pagecount", pageCount);
            sessionStorage.setItem("schxxtcontentlist_txtschid", txtschid);
            sessionStorage.setItem("schxxtcontentlist_cotycode", cotycode);
            sessionStorage.setItem("schxxtcontentlist_schname", schname);
            sessionStorage.setItem("schxxtcontentlist_aprovserch", aprovserch);
            sessionStorage.setItem("schxxtcontentlist_acityserch", acityserch);
            sessionStorage.setItem("schxxtcontentlist_ustat", ustat);
            return false;
        };
        //页面缓存,页面是返回的
        var l = sessionStorage.getItem("schxxtcontentlist");
        if (l != null) {
            $("#main-container").html(l);            //删除缓存
            sessionStorage.removeItem("schxxtcontentlist");
            //取回缓存中的查询条件
            PageIndex = sessionStorage.getItem("schxxtcontentlist_pageindex");
            PageSize = sessionStorage.getItem("schxxtcontentlist_pagesize");
            pageCount = sessionStorage.getItem("schxxtcontentlist_pagecount");
            txtschid = sessionStorage.getItem("schxxtcontentlist_txtschid");
            cotycode = sessionStorage.getItem("schxxtcontentlist_cotycode");
            schname = sessionStorage.getItem("schxxtcontentlist_schname");
            aprovserch = sessionStorage.getItem("schxxtcontentlist_aprovserch");
            acityserch = sessionStorage.getItem("schxxtcontentlist_acityserch");
            ustat = sessionStorage.getItem("schxxtcontentlist_ustat");
            sessionStorage.removeItem("schxxtcontentlist_ustat");
            sessionStorage.removeItem("schxxtcontentlist_pageindex");
            sessionStorage.removeItem("schxxtcontentlist_pagesize");
            sessionStorage.removeItem("schxxtcontentlist_pagecount");
            sessionStorage.removeItem("schxxtcontentlist_txtschid");
            sessionStorage.removeItem("schxxtcontentlist_cotycode");
            sessionStorage.removeItem("schxxtcontentlist_schname");
            sessionStorage.removeItem("schxxtcontentlist_aprovserch");
            sessionStorage.removeItem("schxxtcontentlist_acityserch");
        }
        ...
        function getdata() {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SchXXTContentList.aspx/page",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
        ...
        function dodata(data) {
            if (data.list != null) {
                ...
                $.each(data.list, function (index, item) { //遍历返回的json 
                    ...
                    str += '<td title="' + item.HomeSchPlatName + '">' + (item.HomeSchPlatName == null ? '' : (item.HomeSchPlatName.length > 6 ? item.HomeSchPlatName.substr(0, 6) + '...' : item.HomeSchPlatName)) + '</td>';

                    str += '<td title="' + item.HomeSchPlatUrl + '">' + (item.HomeSchPlatUrl == null ? '' : (item.HomeSchPlatUrl.length > 8 ? item.HomeSchPlatUrl.substr(0, 8) + '...' : item.HomeSchPlatUrl)) + '</td>';
                    ...
                    str += '<a class="blue" href="SchXXTContentTba.aspx?schid=' + item.SchId + '" onclick="go()">';
