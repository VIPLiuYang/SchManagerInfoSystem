...
{
    public partial class SchXXTBasicerList : System.Web.UI.Page
    {
        ...
        public static Com.DataPack.DataRsp<string> page(string PageIndex, string PageSize, string txtname, string ustat, string cotycode, string schid, string aprovserch, string acityserch, string txtschid)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        strwhere += " and Stat='1' and HomeSchBasicStat='" + Com.Public.SqlEncStr(ustat) + "'";
                    }
                    ...
                    int rowc = 0;
                    int pc = 0;
                    string dbcols = "SchId,SchName,SchoolSection,ServiceName,AreaNo,RecTime,HomeSchEnableTime,HomeSchEndTime,HomeSchBasicStat,HomeSchPlatName,HomeSchPlatIco,HomeSchPlatUrl,HomeSchPlatIP";
