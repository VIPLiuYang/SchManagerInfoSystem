...
{
    public partial class SchSearchList : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static Com.DataPack.DataRsp<string> page(string PageIndex, string PageSize, string txtname, string ustat, string cotycode, string schname, string aprovserch, string acityserch)
        {
            ...
            else
            {
                try
                {
                    ...
                    int rowc = 0;
                    int pc = 0;
                    string dbcols = "SchId,SchName,PlatformName,PlatformUrl,PlatformIco,PlatformIP,SchMaster,SchoolSection,ServiceName,Artisan,SchCreator,RecTime,Stat,iscity,SonSysStat,SourceSerStat,AreaNo";
