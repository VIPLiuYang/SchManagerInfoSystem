<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchStructureSetinfo.aspx.cs" Inherits="SchWebAdmin.Web.SchSearch.SchStructureSetinfo" %>
...
<head>
    ...
    <style type="text/css">
        ...
        /*#SchClassSettingData tr td {line-height:27px;}*/
         /*面包屑导航左边样式*/
        .breadcrumb_border {border-left: 2px solid #63bbff;margin-left: 0px;padding-left: 12px;}
        /*面包屑导航背景样式*/
        .breadcrumb_box {background: white;border-bottom: 1px solid #e4e4e4;}
        /*开设科目、班级设置和部门设置大标题的样式*/
        .subleadertitle {color: #000000;font-size: 14px;font-weight: bold;letter-spacing: 1px;height:20px;line-height:20px;}
        #SchOpenSub {line-height:20px;height:20px;font-size:13px;color:#666666;}
        #SchClassSetting #SchClassSettingData thead tr td {text-align:center;font-weight:bold; font-size: 13px;color: #444444 !important;letter-spacing: 1px !important;line-height: 1.5 !important;}
        /* dropdown */
        .dropdown{/*width:186px;margin:0 auto;*/margin-left:15px;margin-top:5px;  position:relative;}
        .dropdown p{font-size:12px;width:72px; height:24px; line-height:24px;text-align:center;border:1px solid #3C9BFF;color:#3C9BFF; cursor:pointer;margin:0px;}
        ...
        */
        .SchClassResult {margin:0px 0px auto 10px;color:#B4B3B5;line-height:24px;}
        .SchClassResult .item {border:#CDCDCD solid 1px;margin:5px;padding-left:5px;padding-right:5px;}
        .SchClassResult .item .closeitem {margin-left:10px;font-size:12px;border:0px;line-height:22px;cursor:pointer;}
        #EditCfmGradeClass .modal-body input {width:20px;height:20px;margin:0px;}
        #EditCfmGradeClass .modal-body .classtit {width:48px;height:20px;}
        #EditCfmGradeClass .modal-body .row {padding:5px 0px 5px 0px;}
    </style>
</head>
<body>
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="row no-margin-right no-margin-left">
                            <div class="col-sm-1 no-padding text-center subleadertitle">班级信息：</div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="row no-margin-right no-margin-left">
                            <div class="col-sm-1 no-padding text-center subleadertitle">部门信息：</div>
                        </div>
                    </div>
                    <div class="space-10"></div>
                    <div class="row">
        ...
        <div class="modal-dialog" style="width: 45%; height: 65%;">
            <div class="modal-content message_align" style="width: 100%; /*height: 95%;*/">
                ...
                <div class="modal-footer" style=" margin-top: 0px;">
                    ...
                    <button type="button" class="btn btn-primary" id="SchClassSaveData">保存</button>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function getClassData(){
        ...
        $.ajax({
            type: "POST",  //请求方式
            url: "SchStructureSetinfo.aspx/getclassdatas",  //请求路径：页面/方法名字
            data: params,     //参数
            dataType: "json",
    ...
    function getSchSub(){
        ...
        $.ajax({
            type: "POST",  //请求方式
            url: "SchStructureSetinfo.aspx/getschsub",  //请求路径：页面/方法名字
            data: params,     //参数
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success: function (data) {
    ...
    function getSchGrade(){
        ...
        $.ajax({
            type: "POST",  //请求方式
            url: "SchStructureSetinfo.aspx/getschgrade",  //请求路径：页面/方法名字
            data: params,     //参数
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success: function (data) {
            ...
            $.each(schgradeinfo, function (index, item) { //遍历返回的json
                ...
                $.each(data,function(indexs,items){
                    if(item.GradeId==items.GradeId){
                        ...
                        schgradedom +="<div class=\"item fl\" val=\"" + items.ClassId + "\" ><input type=\"hidden\" name=\"valname\" gradeid=\""+item.GradeId+"\" value=\""+items.ClassName+"\" />" + items.ClassName + "<span class=\"closeitem\"></span></div>";
                    }
                });
                schgradedom +="         </div>";
    ...
    $(document).ready(function(){
        ...
        $(document).on("click",".dropdown p",function(){
            ...
            var selectitem = $(this).parent(".dropdown").parent("td").find(".SchClassResult").find("input");
    ...
    $(document).on("click","#SchClassSaveData",function(){
        ...
        if(classnamestr.toString()!=""){
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SchStructureSetinfo.aspx/ClassNameSave",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
    ...
    $(document).on("click", ".closeitem", function () {
        ...
        $.ajax({
            type: "POST",  //请求方式
            url: "SchStructureSetinfo.aspx/ClassDelete",  //请求路径：页面/方法名字
            data: params,     //参数
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success: function (data) {
    ...
    function getdata() {
        ...
        $.ajax({
            type: "POST",  //请求方式
            url: "SchStructureSetinfo.aspx/getdpt",  //请求路径：页面/方法名字
            data: params,     //参数
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success: function (data) {
        ...
        BootstrapDialog.confirm({
            ...
            callback: function (result) {
                if (result) {// 点击确定按钮时，result为true
                    ...
                    $.ajax({
                        type: "POST",  //请求方式
                        url: "SchStructureSetinfo.aspx/deldpt",  //请求路径：页面/方法名字
                        data: params,     //参数
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
    ...
    function savedpt() {
        ...
        $.ajax({
            type: "POST",  //请求方式
            url: "SchStructureSetinfo.aspx/updpt",  //请求路径：页面/方法名字
            data: params,     //参数
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success: function (data) {
    ...
    function adddpt() {
        ...
        $.ajax({
            type: "POST",  //请求方式
            url: "SchStructureSetinfo.aspx/adddpt",  //请求路径：页面/方法名字
            data: params,     //参数
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success: function (data) {
    ...
    $("#orderidbtn .MoveUp").click(function () {
        ...
        $.ajax({
            type: "POST",  //请求方式
            url: "SchStructureSetinfo.aspx/MoveUpDown",  //请求路径：页面/方法名字
            data: params,     //参数
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success: function (data) {
