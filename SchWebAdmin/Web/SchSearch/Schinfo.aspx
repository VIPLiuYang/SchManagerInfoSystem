<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Schinfo.aspx.cs" Inherits="SchWebAdmin.Web.SchSearch.Schinfo" %>
                        ...
                        <form class="form-horizontal  " role="form">
                            ...
                            <div class="row">
                                <div class="form-group form-inline">
                                    ...
                                    <div class="col-sm-1 no-padding text-right text_style ">
                                        <label class="initpwd">初始密码:</label>
                                    </div> 
                                       <div class="col-sm-2 input_box">
                                        ...
                                        <div class="col-sm-11 no-padding text-left">
                                            ...
                                            <div class="row" style="margin-right:0px;margin-left:0px;padding-left:5px;">
                                                ...
                                                <div class="col-sm-10 text-left">
                                                    ...
                                                    <div class="btn-group">                                                     
                                                        <div id="downhomsch3"" class="dropdown-menu" style="margin-left:0px;margin-right:0px;clear:both;"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-right:0px;margin-left:0px;padding-left:5px;">
