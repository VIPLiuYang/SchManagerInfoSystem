<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysTerm.aspx.cs" Inherits="SchWebAdmin.Web.SysSchbasic.SysTerm" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function getdata() {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SysTerm.aspx/page",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
        ...
        function CreatModal(autoid, systype) {
            $("#EditCfmCreate .modal-title").html("添加/修改季期");
            var url = "SysTermDialog.aspx?autoid=" + autoid + "&systype=" + systype;
        ...
        function dodata(data) {
            if (data.list != null) {
                ...
                $.each(data.list, function (index, item) { //遍历返回的json 
                    ...
                    str += '<td class="center">' + item.TermCode + '</td>';
                    str += '<td>' + item.TermName + '</td>';
                    str += '<td>';
