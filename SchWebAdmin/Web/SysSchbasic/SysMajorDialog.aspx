<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysMajorDialog.aspx.cs" Inherits="SchWebAdmin.Web.SysSchbasic.SysMajorDialog" %>
...
<body>
        ...
        <div class="main-container-inner">
            <div class="main-content" style="margin-left: 0px">
                <div class="page-content">
                    ...
                    <div class="row">
                            <div class="col-xs-12 text-right"><input type="text" id="AutoId" hidden="hidden" />
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SysMajorDialog.aspx/save",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
