<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysArtsDialog.aspx.cs" Inherits="SchWebAdmin.Web.SysSchbasic.SysArtsDialog" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        {   
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SysArtsDialog.aspx/save",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
