<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysCollDialog.aspx.cs" Inherits="SchWebAdmin.Web.SysSchbasic.SysCollDialog" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SysCollDialog.aspx/save",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
