<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysMajor.aspx.cs" Inherits="SchWebAdmin.Web.SysSchbasic.SysMajor" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<body>
    ...
    <script type="text/javascript">
        ...
        function CreatModal(autoid, systype) {
            $("#EditCfmCreate .modal-title").html("添加/修改专业");
            var url = "SysMajorDialog.aspx?autoid=" + autoid + "&systype=" + systype;
        ...
        function getdata() {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SysMajor.aspx/page",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
        ...
        function dodata(data) {
            if (data.list != null) {
                ...
                $.each(data.list, function (index, item) { //遍历返回的json 
                    ...
                    str += '<td class="center">' + item.MajorCode + '</td>';
