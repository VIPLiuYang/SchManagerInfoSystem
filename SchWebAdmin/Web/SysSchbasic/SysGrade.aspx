<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysGrade.aspx.cs" Inherits="SchWebAdmin.Web.SysSchbasic.SysGrade" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<body>
    ...
    <script type="text/javascript">
        ...
        function CreatModal(autoid, systype) {
            $("#EditCfmCreate .modal-title").html("添加/修改年级");
            var url = "SysGradeDialog.aspx?autoid=" + autoid + "&systype=" + systype;
        ...
        function getdata() {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SysGrade.aspx/page",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
        ...
        function dodata(data) {
            if (data.list != null) {
                ...
                str += ' <th class="center">所在学段</th>';
                str += ' <th class="center">年级编号</th>';
                str += ' <th>年级名称</th>';
                str += ' <th>操作</th>';
                str += '</tr>';
                str += '</thead>';
                ...
                $.each(data.list, function (index, item) { //遍历返回的json 
                    ...
                    str += '<td class="center">' + item.PerName + '</td>';
                    str += '<td class="center">' + item.GradeCode + '</td>';
