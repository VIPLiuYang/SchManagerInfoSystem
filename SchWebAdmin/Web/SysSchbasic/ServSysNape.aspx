<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServSysNape.aspx.cs" Inherits="SchWebAdmin.Web.SysSchbasic.ServSysNape" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function CreatModal(autoid, systype) {
            ...
            var url = "ServSysNapeDialog.aspx?autoid=" + autoid + "&systype=" + systype;
        ...
        function getdata() {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "ServSysNape.aspx/page",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
        ...
        function dodata(data) {
            if (data.list != null) {
                ...
                $.each(data.list, function (index, item) { //遍历返回的json 
                    ...
                    str += '<td class="center">' + item.NapeCode + '</td>';
                    str += '<td>' + item.NapeName + '</td>';
                    if (item.Stat == "1") {
