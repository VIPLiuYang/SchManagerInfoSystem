...
{
    public partial class SysUType : System.Web.UI.Page
    {
        ...
        public static Com.DataPack.DataRsp<string> page(string PageIndex, string PageSize)
        {
            ...
            else
            {
                try
                {
                    ...
                    DataTable dt = sysutypebll.GetListCols("AutoId,UTypeName,UTypeCode,Stat", strwhere, "UTypeCode", "ASC", pages.PageIndex, pages.PageSize, ref rowc, ref pc).Tables[0];
                    pages.PageCount = pc;
                    pages.RowCount = rowc;
                    if (dt.Rows.Count > 0)
                    {
