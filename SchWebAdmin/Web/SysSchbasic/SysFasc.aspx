<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysFasc.aspx.cs" Inherits="SchWebAdmin.Web.SysSchbasic.SysFasc" %> 
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<body>
    ...
    <script type="text/javascript">
        ...
        function getdata() {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SysFasc.aspx/page",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
        ...
        function CreatModal(autoid, systype) {
            $("#EditCfmCreate .modal-title").html("添加/修改教材分册");
            var url = "SysFascDialog.aspx?autoid=" + autoid + "&systype=" + systype;
        ...
        function dodata(data) {
            if (data.list != null) {
                ...
                $.each(data.list, function (index, item) { //遍历返回的json  
                    ...
                    str += '<td class="center">' + item.FascCode + '</td>';
                    str += '<td>' + item.FascName + '</td>';
                    if (item.Stat == "1") {
                    ...
                    //str += "<a href='javascript:del(" + item.AutoId + ")' class='tooltip-error' data-rel='tooltip' title='删除'>";
