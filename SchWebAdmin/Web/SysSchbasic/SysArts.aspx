<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysArts.aspx.cs" Inherits="SchWebAdmin.Web.SysSchbasic.SysArts" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function CreatModal(autoid, systype) {
            $("#EditCfmCreate .modal-title").html("添加/修改分科");
            var url = "SysArtsDialog.aspx?autoid=" + autoid + "&systype=" + systype;
        ...
        function getdata() {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SysArts.aspx/page",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
        ...
        function dodata(data) {
            if (data.list != null) {
                ...
                $.each(data.list, function (index, item) { //遍历返回的json 
                    ...
                    str += '<td class="center">' + item.ArtsCode + '</td>';
                    str += '<td>' + item.ArtsName + '</td>';
                    if (item.Stat == "1") {
