<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysTermDialog.aspx.cs" Inherits="SchWebAdmin.Web.SysSchbasic.SysTermDialog" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        { 
            ...
            var params = '{"Name":"' + Name + '","AutoId":"' + AutoId + '"}';
            $.ajax({
                type: "POST",  //请求方式
                url: "SysTermDialog.aspx/save",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
