<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysColl.aspx.cs" Inherits="SchWebAdmin.Web.SysSchbasic.SysColl" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<body>
    ...
    <script type="text/javascript">
        ...
        function CreatModal(autoid, systype) {
            $("#EditCfmCreate .modal-title").html("添加/修改院系");
            var url = "SysCollDialog.aspx?autoid=" + autoid + "&systype=" + systype;
        ...
        function getdata() {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SysColl.aspx/page",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
        ...
        function dodata(data) {
            if (data.list != null) {
                ...
                $.each(data.list, function (index, item) { //遍历返回的json 
                    ...
                    str += '<td class="center">' + item.CollCode + '</td>';
