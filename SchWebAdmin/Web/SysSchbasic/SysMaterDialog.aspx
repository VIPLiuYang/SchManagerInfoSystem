<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysMaterDialog.aspx.cs" Inherits="SchWebAdmin.Web.SysSchbasic.SysMaterDialog" %>
...
<body>
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-xs-6"><strong>状态:</strong>
                                        <select id="Stat">
    ...
    <script type="text/javascript">
        ...
        {    
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "SysMaterDialog.aspx/save",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
