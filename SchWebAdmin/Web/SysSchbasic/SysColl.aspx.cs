...
{
    public partial class SysColl : System.Web.UI.Page
    {
        ...
        public static Com.DataPack.DataRsp<string> page(string PageIndex, string PageSize)
        {
            ...
            else
            {
                try
                {
                    SchSystem.BLL.SysColl sysarts = new SchSystem.BLL.SysColl();
                    ...
                    DataTable dt = sysarts.GetListCols("AutoId,CollName,CollCode,Stat", strwhere, "CollCode", "ASC", pages.PageIndex, pages.PageSize, ref rowc, ref pc).Tables[0];
                    pages.PageCount = pc;
                    pages.RowCount = rowc;
                    if (dt.Rows.Count > 0)
                    {
