<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServBusThdAdd.aspx.cs" Inherits="SchWebServ.Web.ServBusThd.ServBusThdAdd" %>
...
<body ontouchstart>
    ...
    <script type="text/javascript">
        ...
        function saveuser() {
            ...
            if (Mbusid.value == 0) { alert("请选择对应套餐"); return; }
