            ...
            else
            {
                ...
                try
                {
                    ...
                    foreach (string str in arr)
                    {
                        ...
                        else if (strarr[0] == "ThdName") { servbusmodel.ThdName = strarr[1].Trim(); }
                        ...
                        else if (strarr[0] == "currentCnName") { currentCnName = strarr[1].Trim(); }
                        else if (strarr[0] == "currentCode") { currentCode = strarr[1].Trim(); }
                    }
