<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServBusAdd.aspx.cs" Inherits="SchWebServ.Web.ServBus.ServBusAdd" %>
...
<body ontouchstart>
                ...
                <div class="page-content content_box ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-2 text-left">
                            <input type="hidden" id="PlatformIco" placeholder="" data-toggle="tooltip" maxlength="20" class="col-xs-5 col-sm-5" readonly="readonly" disabled="disabled" /> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 text-left">
                            <select id="BusType" style="width:165px">
                        ...
                        <div class="col-xs-3 text-left">
                            <input type="text" name="FeeCode" id="FeeCode" onkeyup="isInteger(this)" placeholder="请输入金额" maxlength="10" />
                        </div>
                    </div>
                    <div class="space-8"></div>
                    ...
                    <div class="space-8"></div>
                    <div class="row">
                        <div class="col-xs-2 text-right">业务功能:</div>
    ...
    <script type="text/javascript">
        ...
        function saveuser() {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "ServBusAdd.aspx/ServBusAddSave",  //请求路径：页面/方法名字
    ...
    <script type="text/javascript" src="js/UploadicoAdd.js"></script>
    <!--学校添加页面的上传图标-->
</body>
</html>
