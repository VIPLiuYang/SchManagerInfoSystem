<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServBusThdAdd.aspx.cs" Inherits="SchWebServ.Web.ServSys.ServBusThdAdd" %>
...
<body ontouchstart>
                ...
                <div class="page-content content_box ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 text-left">
                            <input type="text" name="ServiceId" id="ServiceId" placeholder="000011" maxlength="10" />
                        </div>
                    </div>
                    <div class="space-8"></div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8 text-left">
                            <input type="text" class="col-xs-12" name="Note" id="Note" placeholder="请输入备注" maxlength="250" />
                        </div>
                    </div>
                    <div class="space-8"></div>
                    <div class="row">
    ...
    <script type="text/javascript">
        ...
        function saveuser() {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "ServBusThdAdd.aspx/ServBusThdAddSave",  //请求路径：页面/方法名字
