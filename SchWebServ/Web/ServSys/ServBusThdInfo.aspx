<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServBusThdInfo.aspx.cs" Inherits="SchWebServ.Web.ServSys.ServBusThdInfo" %> 
        ...
        function dodata(data) {
            if (eval("(" + data + ")").list != null) {
                ...
                $.each(eval("(" + data + ")").list, function (index, item) { //遍历返回的json 
                    ...
                    str += '<td class="center">' + item.Note + '</td>';
                    str += '<td>';
                    ...
                    str += '</button>';
                    str += '<li>';
                    str += '<a href="javascript:EditCfmServBus(' + item.BusId + ')" class="tooltip-success" data-rel="tooltip" title="编辑" onclick="go();">';
