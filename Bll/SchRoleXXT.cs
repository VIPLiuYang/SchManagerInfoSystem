...
namespace SchSystem.BLL
{
    ...
    {
        private readonly SchSystem.DAL.SchRoleXXT dal = new SchSystem.DAL.SchRoleXXT();
        public SchRoleXXT()
        { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        //public SchSystem.Model.SchRoleXXT GetModelByCache(int RoleId)
        //{
        ...
        //        catch{}
        //    }
        //    return (SchSystem.Model.SchRoleXXT)objModel;
        //}
        ...
        /// 获得数据列表
        /// </summary>
        public List<SchSystem.Model.SchRoleXXT> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<SchSystem.Model.SchRoleXXT> DataTableToList(DataTable dt)
        {
            List<SchSystem.Model.SchRoleXXT> modelList = new List<SchSystem.Model.SchRoleXXT>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                SchSystem.Model.SchRoleXXT model;
