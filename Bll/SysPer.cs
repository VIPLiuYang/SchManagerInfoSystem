...
namespace SchSystem.BLL
{
	...
	{
		private readonly SchSystem.DAL.SysPer dal=new SchSystem.DAL.SysPer();
		public SysPer()
		{}
		#region  BasicMethod
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public SchSystem.Model.SysPer GetModelByCache(int AutoId)
        //{
			
        //    string CacheKey = "SysPerModel-" + AutoId;
        ...
        //        catch{}
        //    }
        //    return (SchSystem.Model.SysPer)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.SysPer> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.SysPer> DataTableToList(DataTable dt)
		{
			List<SchSystem.Model.SysPer> modelList = new List<SchSystem.Model.SysPer>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SchSystem.Model.SysPer model;
