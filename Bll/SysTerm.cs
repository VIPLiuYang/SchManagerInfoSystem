...
namespace SchSystem.BLL
{
    ...
    {
        private readonly SchSystem.DAL.SysTerm dal = new SchSystem.DAL.SysTerm();
        public SysTerm()
        { }
        #region  BasicMethod
        ...
        /// 获得数据列表
        /// </summary>
        public List<SchSystem.Model.SysTerm> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<SchSystem.Model.SysTerm> DataTableToList(DataTable dt)
        {
            List<SchSystem.Model.SysTerm> modelList = new List<SchSystem.Model.SysTerm>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                SchSystem.Model.SysTerm model;
