...
namespace SchSystem.BLL
{
	...
	{
		private readonly SchSystem.DAL.ServUserForDetail dal=new SchSystem.DAL.ServUserForDetail();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
        //public SchSystem.Model.ServUserForDetail GetModelByCache(int AutoId)
        //{
			
        //    string CacheKey = "ServUserForDetailModel-" + AutoId;
        ...
        //        catch{}
        //    }
        //    return (SchSystem.Model.ServUserForDetail)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.ServUserForDetail> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.ServUserForDetail> DataTableToList(DataTable dt)
		{
			List<SchSystem.Model.ServUserForDetail> modelList = new List<SchSystem.Model.ServUserForDetail>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SchSystem.Model.ServUserForDetail model;
