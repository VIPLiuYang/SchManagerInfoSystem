...
namespace SchSystem.BLL
{
	...
	{
        private readonly SchSystem.DAL.SchAppRoleXXT dal = new SchSystem.DAL.SchAppRoleXXT();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
        //public SchWebAdmin.Model.SchAppRoleXXT GetModelByCache(int AutoId)
        //{
			
        //    string CacheKey = "SchAppRoleXXTModel-" + AutoId;
        ...
        //        catch{}
        //    }
        //    return (SchWebAdmin.Model.SchAppRoleXXT)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
        public List<SchSystem.Model.SchAppRoleXXT> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
        public List<SchSystem.Model.SchAppRoleXXT> DataTableToList(DataTable dt)
		{
            List<SchSystem.Model.SchAppRoleXXT> modelList = new List<SchSystem.Model.SchAppRoleXXT>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
                SchSystem.Model.SchAppRoleXXT model;
