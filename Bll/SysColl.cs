...
namespace SchSystem.BLL
{
    ...
    {
        private readonly SchSystem.DAL.SysColl dal = new SchSystem.DAL.SysColl();
        public SysColl()
        { }
        #region  BasicMethod
        ...
        /// 获得数据列表
        /// </summary>
        public List<SchSystem.Model.SysColl> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<SchSystem.Model.SysColl> DataTableToList(DataTable dt)
        {
            List<SchSystem.Model.SysColl> modelList = new List<SchSystem.Model.SysColl>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                SchSystem.Model.SysColl model;
