...
namespace SchSystem.BLL
{
	...
	{
        private readonly SchSystem.DAL.SchApp dal = new SchSystem.DAL.SchApp();
		public SchApp()
		{}
		#region  BasicMethod
        ...
        */
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
        public SchSystem.Model.SchApp GetModelByCache(int AutoId)
		{
            ...
            return (SchSystem.Model.SchApp)objModel;
		}
        */
		/// <summary>
		/// 获得数据列表
		...
		/// 获得数据列表
		/// </summary>
        public List<SchSystem.Model.SchApp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
        public List<SchSystem.Model.SchApp> DataTableToList(DataTable dt)
		{
            List<SchSystem.Model.SchApp> modelList = new List<SchSystem.Model.SchApp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
                SchSystem.Model.SchApp model;
