...
namespace SchSystem.BLL
{
    ...
    {
        private readonly SchSystem.DAL.SchMenuInfoUserFunc dal = new SchSystem.DAL.SchMenuInfoUserFunc();
        ...
        /// 获得数据列表
        /// </summary>
        public List<SchSystem.Model.SchMenuInfoUserFunc> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<SchSystem.Model.SchMenuInfoUserFunc> DataTableToList(DataTable dt)
        {
            List<SchSystem.Model.SchMenuInfoUserFunc> modelList = new List<SchSystem.Model.SchMenuInfoUserFunc>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                SchSystem.Model.SchMenuInfoUserFunc model;
