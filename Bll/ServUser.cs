...
namespace SchSystem.BLL
{
	...
	{
		private readonly SchSystem.DAL.ServUser dal=new SchSystem.DAL.ServUser();
		public ServUser()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
        //public SchSystem.Model.ServUser GetModelByCache(int AutoId)
        //{
			
        //    string CacheKey = "ServUserModel-" + AutoId;
        ...
        //        catch{}
        //    }
        //    return (SchSystem.Model.ServUser)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.ServUser> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.ServUser> DataTableToList(DataTable dt)
		{
			List<SchSystem.Model.ServUser> modelList = new List<SchSystem.Model.ServUser>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SchSystem.Model.ServUser model;
