...
namespace SchSystem.BLL
{
	...
	{
        private readonly SchSystem.DAL.SchPerSubMat dal = new SchSystem.DAL.SchPerSubMat();
		public SchPerSubMat()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
        //public SchSystem.Model.SchPerSubMat GetModelByCache(int AutoId)
        //{
			
        //    string CacheKey = "SchPerSubMatModel-" + AutoId;
        ...
        //        catch{}
        //    }
        //    return (SchWebAdmin.Model.SchPerSubMat)objModel;
        //}
        ...
        {
            return dal.SchPerSubMatVMatSub(strWhere);
        }
		/// <summary>
		/// 获得前几行数据
		/// </summary>
		...
		/// 获得数据列表
		/// </summary>
        public List<SchSystem.Model.SchPerSubMat> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
        public List<SchSystem.Model.SchPerSubMat> DataTableToList(DataTable dt)
		{
            List<SchSystem.Model.SchPerSubMat> modelList = new List<SchSystem.Model.SchPerSubMat>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
                SchSystem.Model.SchPerSubMat model;
