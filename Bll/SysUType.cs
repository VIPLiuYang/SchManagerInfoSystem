...
namespace SchSystem.BLL
{
	...
	{
		private readonly SchSystem.DAL.SysUType dal=new SchSystem.DAL.SysUType();
		public SysUType()
		{}
		#region  BasicMethod
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public SchSystem.Model.SysUType GetModelByCache(int AutoId)
        //{
			
        //    string CacheKey = "SysUTypeModel-" + AutoId;
        ...
        //        catch{}
        //    }
        //    return (SchSystem.Model.SysUType)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.SysUType> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.SysUType> DataTableToList(DataTable dt)
		{
			List<SchSystem.Model.SysUType> modelList = new List<SchSystem.Model.SysUType>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SchSystem.Model.SysUType model;
