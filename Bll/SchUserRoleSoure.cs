...
namespace SchSystem.BLL
{
	...
	{
		private readonly SchSystem.DAL.SchUserRoleSoure dal=new SchSystem.DAL.SchUserRoleSoure();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
        //public SchSystem.Model.SchUserRoleSoure GetModelByCache(int AutoId)
        //{
        ...
        //        catch{}
        //    }
        //    return (SchSystem.Model.SchUserRoleSoure)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.SchUserRoleSoure> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.SchUserRoleSoure> DataTableToList(DataTable dt)
		{
			List<SchSystem.Model.SchUserRoleSoure> modelList = new List<SchSystem.Model.SchUserRoleSoure>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SchSystem.Model.SchUserRoleSoure model;
