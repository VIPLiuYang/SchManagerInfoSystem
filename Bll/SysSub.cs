...
namespace SchSystem.BLL
{
    ...
    {
        private readonly SchSystem.DAL.SysSub dal = new SchSystem.DAL.SysSub();
        public SysSub()
        { }
        #region  BasicMethod
        ...
        /// 获得数据列表
        /// </summary>
        public List<SchSystem.Model.SysSub> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<SchSystem.Model.SysSub> DataTableToList(DataTable dt)
        {
            List<SchSystem.Model.SysSub> modelList = new List<SchSystem.Model.SysSub>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                SchSystem.Model.SysSub model;
