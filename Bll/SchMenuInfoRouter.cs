...
namespace SchSystem.BLL
{
    ...
    {
        private readonly SchSystem.DAL.SchMenuInfoRouter dal = new SchSystem.DAL.SchMenuInfoRouter();
        ...
        /// 获得数据列表
        /// </summary>
        public List<SchSystem.Model.SchMenuInfoRouter> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<SchSystem.Model.SchMenuInfoRouter> DataTableToList(DataTable dt)
        {
            List<SchSystem.Model.SchMenuInfoRouter> modelList = new List<SchSystem.Model.SchMenuInfoRouter>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                SchSystem.Model.SchMenuInfoRouter model;
