...
namespace SchSystem.BLL
{
	...
	{
		private readonly SchSystem.DAL.SysFasc dal=new SchSystem.DAL.SysFasc();
		public SysFasc()
		{}
		#region  BasicMethod
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public SchSystem.Model.SysFasc GetModelByCache(int AutoId)
        //{
			
        //    string CacheKey = "SysFascModel-" + AutoId;
        ...
        //        catch{}
        //    }
        //    return (SchSystem.Model.SysFasc)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.SysFasc> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.SysFasc> DataTableToList(DataTable dt)
		{
			List<SchSystem.Model.SysFasc> modelList = new List<SchSystem.Model.SysFasc>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SchSystem.Model.SysFasc model;
