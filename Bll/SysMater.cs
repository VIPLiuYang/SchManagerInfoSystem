...
namespace SchSystem.BLL
{
	...
	{
		private readonly SchSystem.DAL.SysMater dal=new SchSystem.DAL.SysMater();
		public SysMater()
		{}
		#region  BasicMethod
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public SchSystem.Model.SysMater GetModelByCache(int AutoId)
        //{
			
        //    string CacheKey = "SysMaterModel-" + AutoId;
        ...
        //        catch{}
        //    }
        //    return (SchSystem.Model.SysMater)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.SysMater> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.SysMater> DataTableToList(DataTable dt)
		{
			List<SchSystem.Model.SysMater> modelList = new List<SchSystem.Model.SysMater>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SchSystem.Model.SysMater model;
