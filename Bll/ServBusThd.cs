...
namespace SchSystem.BLL
{
	...
	{
		private readonly SchSystem.DAL.ServBusThd dal=new SchSystem.DAL.ServBusThd();
		public ServBusThd()
		{}
		#region  BasicMethod
        ...
        {
            return dal.GetServBusNames(strWhere);
        }
		/// <summary>
		/// 更新一条数据
		/// </summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
        //public SchSystem.Model.ServBusThd GetModelByCache(int BusId)
        //{
			
        //    string CacheKey = "ServBusThdModel-" + BusId;
        ...
        //        catch{}
        //    }
        //    return (SchSystem.Model.ServBusThd)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.ServBusThd> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.ServBusThd> DataTableToList(DataTable dt)
		{
			List<SchSystem.Model.ServBusThd> modelList = new List<SchSystem.Model.ServBusThd>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SchSystem.Model.ServBusThd model;
