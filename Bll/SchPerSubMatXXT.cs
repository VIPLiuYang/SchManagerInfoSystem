...
namespace SchSystem.BLL
{
	...
	{
		private readonly SchSystem.DAL.SchPerSubMatXXT dal=new SchSystem.DAL.SchPerSubMatXXT();
        ...
        {
            return dal.SchPerSubMatXXTV(strWhere);
        }
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.SchPerSubMatXXT> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SchSystem.Model.SchPerSubMatXXT> DataTableToList(DataTable dt)
		{
			List<SchSystem.Model.SchPerSubMatXXT> modelList = new List<SchSystem.Model.SchPerSubMatXXT>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SchSystem.Model.SchPerSubMatXXT model;
