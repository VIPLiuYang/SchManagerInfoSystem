<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StuShow.aspx.cs" Inherits="SchWeb.SchoolBaxicInfo.Student.StuShow" %>
                                ...
                                <div class=" form-inline lheight">
                                    ...
                                    <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-8 jianju">
                                                <label>
                                                    <input name="StudyType" type="radio" checked="checked" readonly="readonly" disabled="disabled" value="1" class="ace">
