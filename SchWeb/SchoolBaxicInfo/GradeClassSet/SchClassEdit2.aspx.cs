...
{
    public partial class SchClassEdit2 : System.Web.UI.Page
    {
        //进入此页需要确认的三个关键参数
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataTable dtclassuser = userclassbll.GetList("UserName id,SubCode subcode,IsMs isms", "ClassId=" + Com.Public.SqlEncStr(classid)).Tables[0];
                ...
                //{
                //    foreach (DataRow drc in dtuser.Rows)
                //    {
                //        sb.Append("<option value=\"" + drc["UserName"].ToString() + "\">" + drc["UserTname"].ToString() + "</option>");
                //    }
                //}
                ...
                //    {
                //        string nodeID = dr["DeptId"].ToString();
                //        string nodeText = dr["UserTname"].ToString();
                //        string nodeUname = dr["UserName"].ToString();
                //        if (dtclassuser.Rows.Count > 0)
                //        {
                //            foreach (DataRow drc in dtclassRow)
                //            {
                //                string uname = drc["UserName"].ToString();
                //                if (nodeUname == uname)
                //                {
                //                    sb.Append("<option value=\"" + nodeID + "\" rel=\"" + nodeUname + "\" selected=\"selected\">" + nodeText + "</option>");
                //                }
                //                else
                //                {
                //                    sb.Append("<option value=\"" + nodeID + "\" rel=\"" + nodeUname + "\">" + nodeText + "</option>");
                //                }
                //            }
                //        }
