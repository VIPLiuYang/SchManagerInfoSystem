<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StuGenUnList.aspx.cs" Inherits="SchWeb.SchoolBaxicInfo.StuGenUn.StuGenUnList" %>
				...
				<div class="main-content" style="margin-left:0px">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">学生和家长关系基本数据</li>
						</ul><!-- .breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">学生和家长关系基本数据&nbsp;&nbsp;</h3>
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function (data, textStatus) {
                                                                ...
                                                                $.each(data.rows, function (index, content) {
                                                                    ...
                                                                    text += "       <label>";
                                                                    text += "           <input type=\"checkbox\" class=\"ace\" value=\"" + content.UnId + "\" />";
                                                                    ...
                                                                    text += "		        <i class=\"icon-trash bigger-130\" onclick=\"StuGenDelete(" + content.UnId + ")\"></i>";
                                                                    text += "	        </a>";
                                                                    text += "       </div>";
                                                                    text += "   </td>";
                                                                    text += "<tr>";
...
<script type="text/javascript">
    //软删除数据
    function StuGenDelete(id) {
        if (confirm("确定删除该学生与家长关系信息吗?如果真的删除将无法再恢复此信息！！请确认后再删除！")) {
            $.ajax({
                url: "ashx/StuGenUn.ashx",
                type: "POST",
                async: true,//或false,是否异步
                data: { Action: "Delete", StuGenUn: id },
                dataType: "text",
