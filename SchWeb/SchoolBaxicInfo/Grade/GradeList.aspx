<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeList.aspx.cs" Inherits="SchWeb.SchoolBaxicInfo.Grade.GradeList" %>
...
<body>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">年级基本数据&nbsp;&nbsp;<div id="add" class="btn btn-minier btn-yellow">添加</div></h3>
												...
												<tbody id="StuList">
                                                    <script type="text/javascript">
                                                        $.ajax({
                                                            ...
                                                            data: { Action: "List", PageCount: 20, PageSize: 3, PageIndex: pageI },
                                                            ...
                                                            success: function (data, textStatus) {
                                                                ...
                                                                $.each(data.rows, function (index, content) {
                                                                    ...
                                                                    text += "       <label>";
                                                                    text += "           <input type=\"checkbox\" class=\"ace\" value=\"" + content.GradeId + "\" />";
                                                                    text += "           <span class=\"lbl\"></span>";
                                                                    text += "       </label>";
                                                                    text += "   </td>";
                                                                    text += "   <td>" + content.GradeYear + "</td>";
                                                                    text += "   <td>" + content.GradeCode + "</td>";
                                                                    text += "   <td>" + content.GradeName + "</td>";
                                                                    text += "   <td>" + content.SchName + "</td>";
                                                                    text += "   <td>" + content.LastRecTime + "</td>";
                                                                    text += "   <td>";
                                                                    ...
                                                                    text += "	        </a>";
                                                                    text += "	        <a class=\"green\" href=\"GradeEdit.aspx?id=" + content.GradeId + "\">";
                                                                    text += "		        <i class=\"icon-pencil bigger-130\"></i>";
                                                                    text += "	        </a>";
                                                                    text += "	        <a class=\"red\" href=\"#\">";
                                                                    text += "		        <i class=\"icon-trash bigger-130\" onclick=\"GradeDelete(" + content.GradeId + ")\"></i>";
                                                                    text += "	        </a>";
                                                                    text += "       </div>";
                                                                    text += "   </td>";
                                                                    text += "<tr>";
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //进入添加页面
            $("#add").click(function () {
                self.location.href="GradeEdit.aspx";
            })
        })
    </script>
</body>
