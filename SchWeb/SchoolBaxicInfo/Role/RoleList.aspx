<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleList.aspx.cs" Inherits="SchWeb.SchoolBaxicInfo.Role.RoleList" %>
...
<body>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">角色基本数据&nbsp;&nbsp;<div id="add" class="btn btn-minier btn-yellow">添加</div></h3>
												...
												<tbody id="StuList">
                                                    <script type="text/javascript">
                                                        $.ajax({
                                                            ...
                                                            data: { Action: "List", PageSize: 30, PageIndex: pageI },
                                                            dataType: "json",//返回的数据格式：json/xml/html/script/jsonp/text
                                                            timeout: 5000,    //超时时间
                                                            success: function (data, textStatus) {
                                                                var text = ""; var RoleStat = 0;
                                                                $.each(data.rows, function (index, content) {
                                                                    RoleStat = content.Stat; 
                                                                    if (RoleStat == "1") {
                                                                        RoleStat = "启用";
                                                                    } else {
                                                                        RoleStat = "禁用";
                                                                    ...
                                                                    text += "       <label>";
                                                                    text += "           <input type=\"checkbox\" class=\"ace\" value=\"" + content.RoleId + "\" />";
                                                                    text += "           <span class=\"lbl\"></span>";
                                                                    text += "       </label>";
                                                                    text += "   </td>";
                                                                    text += "   <td>" + content.RoleId + "</td>";
                                                                    text += "   <td>" + content.RoleName + "</td>";
                                                                    text += "   <td>" + RoleStat + "</td>";
                                                                    text += "   <td>";
                                                                    ...
                                                                    text += "		        <i class=\"icon-trash bigger-130\" onclick=\"RoleDelete(" + content.RoleId + ")\" title=\"删除\"></i>";
                                                                    text += "	        </a>";
                                                                    text += "       </div>";
                                                                    text += "   </td>";
                                                                    text += "<tr>";
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //进入添加页面
            $("#add").click(function () {
                self.location.href = "RoleEdit.aspx";
            })
        })
    </script>
</body>
