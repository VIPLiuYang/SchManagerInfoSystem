<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAuth.aspx.cs" Inherits="SchWeb.SchoolBaxicInfo.UserFunAuth.UserAuth" %>
...
<head>
    ...
    font-weight:bold;
        ...
        /*.bootstrap-tagsinput {background-color: #f5f5f5;min-width:87px;min-height:30px;}
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-inline">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3 no-padding-right">
                                            <label>
                                                    <input name="usersex" type="radio" value="1" class="ace" style="margin-right: 6px; vertical-align: middle;"  readonly="readonly" disabled="disabled" >
                                                    <span class="lbl">男</span>
                                                </label>
                                                &nbsp &nbsp &nbsp
                                                <label>
                                                    <input name="usersex" type="radio" value="0" class="ace" readonly="readonly" disabled="disabled">
                                ...
                                <div class="form-inline">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-2 no-padding-right text-left">
                                            <label>
                                                    <input name="userstat" type="radio" value="1" class="ace" readonly="readonly" disabled="disabled" />
                                                    <span class="lbl">正常</span>
                                                </label>
                                                &nbsp;&nbsp;
                                                <label>
                                                    <input name="userstat" type="radio" value="0" class="ace" readonly="readonly" disabled="disabled" />
                                ...
                                <div class="form-inline">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-8 no-padding-right text-left">
                                                ...
                                                <div class="widget-main">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-4">
                                                            ...
                                                            <a href="#" id="savebtn" class="btn btn-sm btn-info btn_size">
    ...
    <script type="text/javascript">
        ...
        function RoleDel(treeId, treeNode)
        {
            ...
            if (confirm(msg)==true){ 
                $.ajax({
                    type: "POST",  //请求方式
                    url: "UserAuth.aspx/roledel",  //请求路径：页面/方法名字
                    data: params,     //参数
                    dataType: "json",
        ...
        function RoleEdit(treeId, treeNode)
        {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "UserAuth.aspx/getrole",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
        ...
        function saverole()
        {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "UserAuth.aspx/uprole",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
        ...
        function addrole()
        {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "UserAuth.aspx/addrole",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
        ...
        function saveuser()
        {
            ...
            */
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "UserAuth.aspx/usersave",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
