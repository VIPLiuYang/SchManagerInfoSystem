<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchSubLeadEdit.aspx.cs" Inherits="SchWeb.SchoolBaxicInfo.UserFuncSoure.SchSubLeadEdit" %>
                ...
                <div class="page-content">
                    ...
                    <div class="space-10"></div>
                            ...
                            <form class="form-horizontal" role="form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-10 no-padding-right text-left">
                                            ...
                                            <!--<div class="btn-group" style>
                                                ...
                                                <ul id="Treedpts" class="dropdown-menu ztree"></ul>
                                            </div>-->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-inline">
                                    <div class="row">
                                        <div class="col-xs-12" style="font-family:微软雅黑 !important;padding-left:50px;color:#f96161;">单击下列部门选择科目组长：</div>
                                    </div>
                                </div>
                                <div class="form-inline">
                                    <div class="row">
