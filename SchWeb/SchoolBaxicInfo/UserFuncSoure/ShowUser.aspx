<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowUser.aspx.cs" Inherits="SchWeb.SchoolBaxicInfo.UserFuncSoure.ShowUser" %>
...
<head>
    ...
    <style>
        ...
        */
        ...
        .bootstrap-tagsinput {background-color: #f5f5f5;}
        .label-info {background-color: #f5f5f5!important;}
        .bootstrap-tagsinput .tag [data-role="remove"]:after {content: "";padding: 0px;}
...
<body ontouchstart>
                            ...
                            <form class="form-horizontal" role="form">
                                <div class="form-inline">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3 no-padding-right">
                                            <input type="text" id="usertname"  data-toggle="tooltip"  maxlength="10"  readonly="readonly" disabled="disabled" />
                                        </div>
                                        <div class="col-xs-1 no-padding text-right titleheight ">
                                            <label>性 别:</label>
                                        </div>
                                        <div class="col-xs-3 no-padding-right">
                                            <label>
                                                    <input name="usersex" type="radio" value="1" class="ace" style="margin-right: 6px; vertical-align: middle;" disabled="disabled" />
                                                    <span class="lbl">男</span>
                                                </label>
                                                &nbsp &nbsp &nbsp
                                                <label>
                                                    <input name="usersex" type="radio" value="0" class="ace" disabled="disabled" />
                                ...
                                <div class="form-inline">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-1 no-padding-right text-left">
                                            <input type="text" id="userpst" maxlength="10" readonly="readonly" disabled="disabled" />
                                        </div>
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-inline">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3 no-padding-right">
                                            <input type="text" id="usertitle" maxlength="10"  readonly="readonly" disabled="disabled" />
                                        </div>
                                        <div class="col-xs-1 no-padding text-right titleheight ">
                                            <label>联系方式:</label>
                                        </div>
                                        <div class="col-xs-3 no-padding-right">
                                            <input type="text" id="usermobile" data-toggle="tooltip" maxlength="11" readonly="readonly" disabled="disabled"  />
                                        </div>
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-inline">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3 no-padding-right">
                                            <input type="text" id="username"  maxlength="18"  readonly="readonly" disabled="disabled" />
                                        </div>
                                        <div class="col-xs-1 no-padding text-right titleheight ">
                                            <label id="lblpwd">密 码:</label>
                                        </div>
                                        <div class="col-xs-3 no-padding-right">
                                            <input type="password" id="userpw" class="col-xs-7"  readonly="readonly" disabled="disabled"  maxlength="18" />
                                        </div>
                                        <div class="col-xs-1 no-padding text-right titleheight ">
                                            <label>账号状态:</label>
                                        </div>
                                        <div class="col-xs-3 no-padding-right">
                                            <label>
                                                    <input name="userstat" type="radio" value="1" class="ace" style="margin-right: 6px; vertical-align: middle;" disabled="disabled" />
                                                    <span class="lbl">正常</span>
                                                </label>
                                                &nbsp;&nbsp;
                                                <label>
                                                    <input name="userstat" type="radio" value="0" class="ace" disabled="disabled" />
    ...
    <script type="text/javascript">
        ...
        function saveuser()
        {
            ...
            if(!checkTxt("#usermobile",'^(^$)|0?(13[0-9]|15[012356789]|17[013678]|18[0-9]|14[57])[0-9]{8}$')){
                alert("请输入正确的手机号码！");
                return false;
            }
