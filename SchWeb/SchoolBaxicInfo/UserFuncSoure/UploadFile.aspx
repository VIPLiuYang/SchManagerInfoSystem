<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFile.aspx.cs" Inherits="SchWeb.SchoolBaxicInfo.UserFuncSoure.UploadFile" %>
...
.tishi {
    ...
    <div class="space-10" style="margin-top: 20px; margin-bottom: 20px;"></div>
                        ...
                        success: function (data, status) {
                            if (data.status == "success01") {
                                ...
                                if(systype=="2"||systype=="1"){
                                    window.location.href = "./SchoolBaxicInfo/SchStructureSet/SchStructureSet.aspx";
                                }else{
