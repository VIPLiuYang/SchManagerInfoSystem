<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateUser.aspx.cs" Inherits="SchWeb.SchoolBaxicInfo.UserFuncSoure.CreateUser" %>
                            ...
                            <form class="form-horizontal" role="form">
                                ...
                                <div class="form-inline">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3 no-padding-right">
                                            <input type="text" id="usermobile" placeholder="请输入联系方式" data-toggle="tooltip" title="11位手机号"  onblur="checkTxt(this,'^(^$)|0?(13[0-9]|15[012356789]|17[013678]|18[0-9]|14[57])[0-9]{8}$')" maxlength="11" />
                                        </div>
                                    </div>
                                </div>
                                <div class="space-4"></div>
