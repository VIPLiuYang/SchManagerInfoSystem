<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserEdit.aspx.cs" Inherits="SchWeb.SchoolBaxicInfo.Users.UserEdit" %>
...
<head>
    ...
    <style>
        ...
        */
        ...
        /*选择部门弹出框二级栏目的字体样式*/
        .dropdown-menu li ul li a span:nth-child(2) {
            color:#999999;
        }
         /*权限说明树状图二级栏目的字体样式*/
        .ztree li ul li a span:nth-child(2){
            color:#999999 !important;
        }
        label { 
            color:#333333;
...
<body ontouchstart>
        ...
        <div class="main-container-inner">
            <div class="main-content" style="margin-left: 0px">
                <div class="breadcrumbs  breadcrumb_box" id="breadcrumbs">
                    ...
                    <ul class="breadcrumb breadcrumb_border" style="font-family: 微软雅黑">
                        <li>
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-10 col-sm-offset-1">
                            ...
                            <form class="form-horizontal" role="form" style="font-family: 微软雅黑">
                                <div class="clearfix form-actions" style="background: none; border: none;">
                                ...
                                <div class="form-group form-inline text_style no-margin-bottom">
                                    <%--<div class="col-sm-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="usercode" data-toggle="tooltip" title="1-20长英文字母和数字,必填" placeholder="编号(必填)" onblur="checkTxt(this,'^[a-zA-Z0-9]{1,20}$')" class="col-xs-12 col-sm-12" />
                                        </div>
                                    </div>--%>
                                    <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-8 input_box ">
                                            <input type="text" id="usertname" placeholder="姓名(必填)" data-toggle="tooltip" title="1-10个汉字长度,必填" onblur="checkTxt(this,'^.{1,10}$')" class="col-xs-12 col-sm-12" maxlength="10" />
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="col-sm-4 no-padding-right text-right text-title">
                                   ...
                                   <%-- <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="usertel" placeholder="固话" data-toggle="tooltip" title="必须符合电话格式" onblur="checkTxt(this,'^(^$)|(0?(13[0-9]|15[012356789]|17[013678]|18[0-9]|14[57])[0-9]{8})|(400|800)([0-9\\-]{7,10})|(([0-9]{4}|[0-9]{3})(-| )?)?([0-9]{7,8})((-| |转)*([0-9]{1,4}))?$')" class="col-xs-12 col-sm-12" />
                                        </div>
                                    </div>--%>
                                    <div class="col-sm-3">
                                        <div class="col-sm-4 no-padding-right text-right text-title">
                                        ...
                                        <div class="col-sm-8 input_box">
                                            <input type="text" id="usermobile" placeholder="请输入联系方式" data-toggle="tooltip" title="11位手机号" onblur="checkTxt(this,'^(^$)|0?(13[0-9]|15[012356789]|17[013678]|18[0-9]|14[57])[0-9]{8}$')" class="col-xs-12 col-sm-12" maxlength="11" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group form-inline text_style  no-margin-bottom">
                                    <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-8 input_box">
                                            <input type="text" id="userpst" placeholder="请输入职务" data-toggle="tooltip" title="10个汉字" onblur="checkTxt(this,'^.{0,10}$')" class="col-xs-12 col-sm-12" maxlength="10" />
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="col-sm-4 no-padding-right text-right text-title">
                                        ...
                                        <div class="col-sm-8 input_box">
                                            <input type="text" id="usertitle" placeholder="请输入职称" data-toggle="tooltip" onblur="checkTxt(this,'^.{0,10}$')" title="10个汉字" class="col-xs-12 col-sm-12" maxlength="10" />
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="col-sm-4 no-padding-right text-right text-title" style="display:none;">
                                            <label>任教科目:</label>
                                        </div>
                               ...
                               <%-- <div class="space-2"></div>--%>
                                <div class="form-group form-inline text_style  no-margin-bottom">
                                    <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-8 input_box">
                                            <input type="text" id="username" placeholder="账号" data-toggle="tooltip" title="字母和数字的长度6-18位组合" onblur="checkTxt(this,'(^$)|^([a-zA-Z0-9]{6,18})$')" maxlength="18" class="col-xs-12 col-sm-12" />
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="col-sm-4 no-padding-right text-right text-title">
                                        ...
                                        <div class="col-sm-8 password input_box">
                                            <input type="password" id="userpw" data-toggle="tooltip" title="字母和数字的长度6-18位组合" onblur="checkTxt(this,'(^$)|^([a-zA-Z0-9]{6,18})$')" maxlength="18" class="col-xs-8 col-sm-8" value="" />
                                ...
                                <div class="space-2"></div>
                                <div class="form-group form-inline tbox text_style no-margin-bottom">
                                    <div class="col-sm-1 no-padding-right  text-right text-title ">
                                ...
                                <div class="form-group form-inline col-sm-11 pull-right no-padding-right no-padding-left no-margin-right no-margin-left table_box text_style" >
                                    <div class="col-sm-3  no-padding-right no-padding-left col-xs-12">
                                    ...
                                    <div class="col-sm-9 col-xs-12 table2">
                                        <div class="widget-box" style="margin: 0px;">
                                            <div class="widget-header widget-header-flat">
                                                <h4>权限说明</h4>
                                            </div>
    ...
    <!-- 模态框   账号重复提示模态框 -->
   <!-- <div class="modal fade" id="Existscfm">
    ...
    <script type="text/javascript">
            ...
            if(treeNodes)
            {
                for (var x in treeNodes) {
                    if(treeNodes[x].checked=='true')
                    {
                        ...
                        treeObj.setting.callback.onClick(null, treeObj.setting.treeId, enodes);
                        break;
                    }
        ...
        function RoleDel(treeId, treeNode)
        {
            ...
            if (confirm(msg)==true){ 
                $.ajax({
                    type: "POST",  //请求方式
                    url: "UserEdit.aspx/roledel",  //请求路径：页面/方法名字
                    data: params,     //参数
                    dataType: "json",
        ...
        function saverole()
        {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "UserEdit.aspx/uprole",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
        ...
        function addrole()
        {
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "UserEdit.aspx/addrole",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
        ...
        function saveuser()
        {
            ...
            */
            ...
            $.ajax({
                type: "POST",  //请求方式
                url: "UserEdit.aspx/usersave",  //请求路径：页面/方法名字
                data: params,     //参数
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
