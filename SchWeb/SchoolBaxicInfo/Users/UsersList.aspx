<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersList.aspx.cs" Inherits="SchWeb.SchoolBaxicInfo.Users.UsersList" %>
                ...
                <div class="page-content">
                    <div class="row">
                        <div class="col-xs-12" id="demo">
                            &nbsp &nbsp &nbsp;&nbsp;<input type="text" id="UserTname" style="width: 200px; height: 25px" placeholder="用户姓名">
                            <button type="button" class="btn-info " v-on:click="sel"><i class="icon-search"></i>查询</button>
                            <button type="button" class="btn-info" v-on:click="add"><i class="icon-plus"></i>添加人员</button>
    ...
    <script type="text/javascript">
        ...
        Vue.component('mytest', {
            ...
            methods: {
                ...
                edit: function (item) {
                    ...
                    self.location.href = "UsersEdit.aspx?depid=" + UserId;
                },
                //删除一行数据方法
                del: function (item) {
                    var msg = "您真的确定要删除吗？\n\n请确认！";
                    if (confirm(msg) == true) {
                        $.ajax({
                            type: "POST",
                            url: "ashx/Users.ashx?action=Delete",
                            dataType: "json",
        ...
        var dt = new Vue({
            ...
            methods: {
                ...
                //添加弹出框
                add: function () {
                    self.location.href = "UsersEdit.aspx";
                }
            }
        })
