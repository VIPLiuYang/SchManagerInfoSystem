<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFile.aspx.cs" Inherits="SchWeb.UploadFile" %>
...
.tishi {
    ...
    <div class="space-10" style="margin-top: 20px; margin-bottom: 20px;height:10px;"></div>
